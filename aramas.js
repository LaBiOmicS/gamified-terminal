...
}), a = Object.defineProperty, o = Object.getOwnPropertyDescriptor, s = (e, t) => {
	for (var n in t) a(e, n, {
		get: t[n],
		enumerable: !0
	});
}, c = (e, t, n, r) => {
	for (var i = r > 1 ? void 0 : r ? o(t, n) : t, s = e.length - 1, c; s >= 0; s--) (c = e[s]) && (i = (r ? c(t, n, i) : c(i)) || i);
	return r && i && a(t, n, i), i;
}, l = (e, t) => (n, r) => t(n, r, e), u = "Terminal input", d = {
	get: () => u,
	set: (e) => u = e
}, f = "Too much output to announce, navigate to rows manually to read", p = {
	get: () => f,
	set: (e) => f = e
};
function m(e) {
...
function _(e, t, n, r) {
	e.stopPropagation(), e.clipboardData && v(e.clipboardData.getData("text/plain"), t, n, r);
}
function v(e, t, n, r) {
	e = m(e), e = h(e, n.decPrivateModes.bracketedPasteMode && r.rawOptions.ignoreBracketedPasteMode !== !0), n.triggerDataEvent(e, !0), t.value = "";
}
function ee(e, t, n) {
...
function te(e, t, n, r, i) {
	ee(e, t, n), i && r.rightClickSelect(e), t.value = r.selectionText, t.select();
}
function ne(e) {
...
var ie = class {
	...
	constructor() {
		this.fg = 0, this.bg = 0, this.extended = new le();
	}
	static toColorRGB(e) {
		return [
			e >>> 16 & 255,
...
}, y = class e extends ce {
	constructor() {
		super(...arguments), this.content = 0, this.fg = 0, this.bg = 0, this.extended = new le(), this.combinedData = "";
	}
...
}, ue = "di$target", b = "di$dependencies", de = /* @__PURE__ */ new Map();
function fe(e) {
	return e[b] || [];
}
function x(e) {
...
var C = x("BufferService"), pe = x("CoreMouseService"), me = x("CoreService"), he = x("CharsetService"), ge = x("InstantiationService"), w = x("LogService"), T = x("OptionsService"), _e = x("OscLinkService"), ve = x("UnicodeService"), ye = x("DecorationService"), be = class {
	constructor(e, t, n) {
	...
	provideLinks(e, t) {
		...
		let r = [], i = this._optionsService.rawOptions.linkHandler, a = new y(), o = n.getTrimmedLength(), s = -1, c = -1, l = !1;
			...
			if (l || c !== -1 && t === o - 1) {
				...
				if (n) {
					...
					s || r.push({
						text: n,
						range: a,
						activate: (e, t) => i ? i.activate(e, t, a) : xe(e, t),
...
var Se = x("CharSizeService"), E = x("CoreBrowserService"), Ce = x("MouseService"), we = x("RenderService"), Te = x("SelectionService"), Ee = x("CharacterJoinerService"), De = x("ThemeService"), Oe = x("LinkProviderService"), ke = new class {
	constructor() {
		this.listeners = [], this.unexpectedErrorHandler = function(e) {
			setTimeout(() => {
				throw e.stack ? Fe.isErrorNoTelemetry(e) ? new Fe(e.message + "\n\n" + e.stack) : /* @__PURE__ */ Error(e.message + "\n\n" + e.stack) : e;
			}, 0);
		};
	}
	addListener(e) {
...
function Ae(e) {
	Me(e) || ke.onUnexpectedError(e);
}
var je = "Canceled";
function Me(e) {
	return e instanceof Ne ? !0 : e instanceof Error && e.name === je && e.message === je;
}
var Ne = class extends Error {
	constructor() {
		super(je), this.name = this.message;
	}
};
function Pe(e) {
...
function Le(e, t, n = 0, r = e.length) {
	let i = n, a = r;
	for (; i < a;) {
...
var Re = class e {
	...
	findLastMonotonous(t) {
		...
		let n = Le(this._array, t, this._findLastMonotonousLastIdx);
		return this._findLastMonotonousLastIdx = n + 1, n === -1 ? void 0 : this._array[n];
	}
};
Re.assertInvariants = !1;
function D(e, t = 0) {
...
var Ve = (e, t) => e - t, He = class e {
	...
	findLastMaxBy(e) {
		let t, n = !0;
		return this.iterate((r) => ((n || ze.isGreaterThan(e(r, t))) && (n = !1, t = r), !0)), t;
	}
};
He.empty = new He((e) => {});
function Ue(e, t) {
	...
	computeLeakingDisposables(e = 10, t) {
		...
		for (let t of n.slice(0, e)) {
			...
			for (let t = 0; t < e.length; t++) {
				...
				let o = Ue([...i.get(e.slice(0, t).join("\n"))].map((e) => r(e)[t]), (e) => e);
				delete o[e[t]];
...
var it = class e {
	constructor() {
		this._toDispose = /* @__PURE__ */ new Set(), this._isDisposed = !1, Ze(this);
	}
	dispose() {
		this._isDisposed || (Qe(this), this._isDisposed = !0, this.clear());
	}
	get isDisposed() {
	...
	add(t) {
		...
		return $e(t, this), this._isDisposed ? e.DISABLE_DISPOSED_WARNING || console.warn((/* @__PURE__ */ Error("Trying to add a disposable to a DisposableStore that has already been disposed of. The added object will be leaked!")).stack) : this._toDispose.add(t), t;
	}
	delete(e) {
		if (e) {
	...
	deleteAndLeak(e) {
		e && this._toDispose.has(e) && (this._toDispose.delete(e), $e(e, null));
	}
};
it.DISABLE_DISPOSED_WARNING = !1;
var at = it, k = class {
	constructor() {
		this._store = new at(), Ze(this), $e(this._store, this);
	}
	dispose() {
		Qe(this), this._store.dispose();
	}
	_register(e) {
...
var ot = class {
	constructor() {
		this._isDisposed = !1, Ze(this);
	}
	get value() {
		return this._isDisposed ? void 0 : this._value;
	}
	set value(e) {
		this._isDisposed || e === this._value || (this._value?.dispose(), e && $e(e, this), this._value = e);
	}
	clear() {
		this.value = void 0;
	}
	dispose() {
		this._isDisposed = !0, Qe(this), this._value?.dispose(), this._value = void 0;
	}
	clearAndLeak() {
		let e = this._value;
		return this._value = void 0, e && $e(e, null), e;
	}
}, st = typeof window == "object" ? window : globalThis, ct = class e {
	constructor(t) {
...
}, ut = globalThis.performance && typeof globalThis.performance.now == "function", dt = class e {
	static create(t) {
		return new e(t);
	}
	constructor(e) {
		this._now = ut && e === !1 ? Date.now : globalThis.performance.now.bind(globalThis.performance), this._startTime = this._now(), this._stopTime = -1;
	}
	stop() {
...
((e) => {
	...
	function t(e) {
		if (mt) {
			let { onDidAddListener: t } = e, n = bt.create(), r = 0;
			e.onDidAddListener = () => {
	...
	e.signal = s;
	function c(...e) {
		return (t, n = null, r) => d(rt(...e.map((e) => e((e) => t.call(n, e)))), r);
	}
	e.any = c;
	function l(e, t, n, r) {
		let a = n;
	...
	class se {
		constructor(e, n) {
			...
			n || t(r), this.emitter = new M(r), n && n.add(this.emitter);
		}
		beginUpdate(e) {
			this._counter++;
		}
	...
	function le(e) {
		return (t, n, r) => {
			...
			return r instanceof at ? r.add(s) : Array.isArray(r) && r.push(s), s;
		};
	}
...
ht.all = /* @__PURE__ */ new Set(), ht._idPool = 0;
var gt = ht, _t = -1, vt = class e {
...
if (ft) {
	...
	}, 3e3), Dt = new FinalizationRegistry((t) => {
		typeof t == "string" && e.push(t);
	});
}
var M = class {
	constructor(e) {
		this._size = 0, this._options = e, this._leakageMon = _t > 0 || this._options?.leakWarningThreshold ? new yt(e?.onListenerError ?? Ae, this._options?.leakWarningThreshold ?? _t) : void 0, this._perfMon = this._options?._profName ? new gt(this._options._profName) : void 0, this._deliveryQueue = this._options?.deliveryQueue;
	}
	dispose() {
		if (!this._disposed) {
	...
	get event() {
		return this._event ??= (e, t, n) => {
			if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
				...
				console.warn(e);
				let t = this._leakageMon.getMostFrequentStack() ?? ["UNKNOWN stack", -1], n = new St(`${e}. HINT: Stack shows most frequent listener (${t[1]}-times)`, t[0]);
				return (this._options?.onListenerError || Ae)(n), k.None;
			}
			if (this._disposed) return k.None;
			t && (e = e.bind(t));
			let r = new wt(e), i;
			this._leakageMon && this._size >= Math.ceil(this._leakageMon.threshold * .2) && (r.stack = bt.create(), i = this._leakageMon.check(r.stack, this._size + 1)), pt && (r.stack = bt.create()), this._listeners ? this._listeners instanceof wt ? (this._deliveryQueue ??= new Ot(), this._listeners = [this._listeners, r]) : this._listeners.push(r) : (this._options?.onWillAddFirstListener?.(this), this._listeners = r, this._options?.onDidAddFirstListener?.(this)), this._size++;
			let a = O(() => {
				Dt?.unregister(a), i?.(), this._removeListener(r);
			});
			if (n instanceof at ? n.add(a) : Array.isArray(n) && n.push(a), Dt) {
				let e = (/* @__PURE__ */ Error()).stack.split("\n").slice(2, 3).join("\n").trim(), t = /(file:|vscode-file:\/\/vscode-app)?(\/[^:]*:\d+:\d+)/.exec(e);
				Dt.register(a, t?.[2] ?? e, a);
			}
			return a;
		}, this._event;
	}
...
At.INSTANCE.onDidChangeZoomLevel;
function Mt(e) {
	return At.INSTANCE.getZoomFactor(e);
}
At.INSTANCE.onDidChangeFullscreen;
var Nt = typeof navigator == "object" ? navigator.userAgent : "", Pt = Nt.indexOf("Firefox") >= 0, Ft = Nt.indexOf("AppleWebKit") >= 0, It = Nt.indexOf("Chrome") >= 0, Lt = !It && Nt.indexOf("Safari") >= 0;
Nt.indexOf("Electron/"), Nt.indexOf("Android");
var Rt = !1;
if (typeof st.matchMedia == "function") {
	let e = st.matchMedia("(display-mode: standalone) or (display-mode: window-controls-overlay)"), t = st.matchMedia("(display-mode: fullscreen)");
	Rt = e.matches, jt(st, e, ({ matches: e }) => {
		Rt && t.matches || (Rt = e);
	});
}
function zt() {
...
var Bt = "en", Vt = !1, Ht = !1, Ut = !1, Wt = !1, Gt = !1, Kt = Bt, qt, Jt = globalThis, N;
typeof Jt.vscode < "u" && typeof Jt.vscode.process < "u" ? N = Jt.vscode.process : typeof process < "u" && typeof process?.versions?.node == "string" && (N = process);
var Yt = typeof N?.versions?.electron == "string" && N?.type === "renderer";
if (typeof N == "object") {
	Vt = N.platform === "win32", Ht = N.platform === "darwin", Ut = N.platform === "linux", Ut && N.env.SNAP && N.env.SNAP_REVISION, N.env.CI || N.env.BUILD_ARTIFACTSTAGINGDIRECTORY, Kt = Bt;
	let e = N.env.VSCODE_NLS_CONFIG;
	if (e) try {
		let t = JSON.parse(e);
		t.userLocale, t.osLocale, Kt = t.resolvedLanguage || Bt, t.languagePack?.translationsConfigFile;
	} catch {}
	Wt = !0;
} else typeof navigator == "object" && !Yt ? (qt = navigator.userAgent, Vt = qt.indexOf("Windows") >= 0, Ht = qt.indexOf("Macintosh") >= 0, (qt.indexOf("Macintosh") >= 0 || qt.indexOf("iPad") >= 0 || qt.indexOf("iPhone") >= 0) && navigator.maxTouchPoints && navigator.maxTouchPoints, Ut = qt.indexOf("Linux") >= 0, qt?.indexOf("Mobi"), Gt = !0, Kt = globalThis._VSCODE_NLS_LANGUAGE || Bt, navigator.language.toLowerCase()) : console.error("Unable to resolve platform.");
var Xt = Vt, Zt = Ht, Qt = Ut, $t = Wt;
Gt && typeof Jt.importScripts == "function" && Jt.origin;
var en = qt, tn = Kt, nn;
((e) => {
	function t() {
		return tn;
	...
	e.value = t;
	function n() {
		return tn.length === 2 ? tn === "en" : tn.length >= 3 ? tn[0] === "e" && tn[1] === "n" && tn[2] === "-" : !1;
	}
...
var rn = typeof Jt.postMessage == "function" && !Jt.importScripts;
(() => {
	if (rn) {
		let e = [];
		Jt.addEventListener("message", (t) => {
		...
		return (n) => {
			...
			e.push({
				id: r,
				callback: n
			}), Jt.postMessage({ vscodeScheduleAsyncWork: r }, "*");
		};
	}
	return (e) => setTimeout(e);
})();
var an = !!(en && en.indexOf("Chrome") >= 0);
en && en.indexOf("Firefox"), !an && en && en.indexOf("Safari"), en && en.indexOf("Edg/"), en && en.indexOf("Android");
var on = typeof navigator == "object" ? navigator : {};
$t || document.queryCommandSupported && document.queryCommandSupported("copy") || on && on.clipboard && on.clipboard.writeText, $t || on && on.clipboard && on.clipboard.readText, $t || zt() || on.keyboard, "ontouchstart" in st || on.maxTouchPoints, st.PointerEvent && ("ontouchstart" in st || navigator.maxTouchPoints);
var sn = class {
	constructor() {
...
}, cn = new sn(), ln = new sn(), un = new sn(), dn = Array(230), fn;
((e) => {
	function t(e) {
	...
	function a(e) {
		return ln.strToKeyCode(e) || un.strToKeyCode(e);
	}
...
var gn = Zt ? 256 : 2048, _n = 512, vn = 1024, yn = Zt ? 2048 : 256, bn = class {
	...
	_computeKeybinding() {
		...
		let t = 0;
		return this.ctrlKey && (t |= gn), this.altKey && (t |= _n), this.shiftKey && (t |= vn), this.metaKey && (t |= yn), t |= e, t;
	}
	_computeKeyCodeChord() {
		let e = 0;
		return this.keyCode !== 5 && this.keyCode !== 4 && this.keyCode !== 6 && this.keyCode !== 57 && (e = this.keyCode), new pn(this.ctrlKey, this.shiftKey, this.altKey, this.metaKey, e);
	}
...
var Cn = class {
	...
	constructor(e, t) {
		...
		let n = Cn.getPositionOfChildWindowRelativeToAncestorWindow(e, t.view);
	...
	constructor(e, t = 0, n = 0) {
		...
		if (e) {
			...
			if (typeof t.wheelDeltaY < "u") r ? this.deltaY = t.wheelDeltaY / (120 * i) : this.deltaY = t.wheelDeltaY / 120;
				...
				let t = e;
				t.deltaMode === t.DOM_DELTA_LINE ? Pt && !Zt ? this.deltaY = -e.deltaY / 3 : this.deltaY = -e.deltaY : this.deltaY = -e.deltaY / 40;
			}
			if (typeof t.wheelDeltaX < "u") Lt && Xt ? this.deltaX = -(t.wheelDeltaX / 120) : r ? this.deltaX = t.wheelDeltaX / (120 * i) : this.deltaX = t.wheelDeltaX / 120;
			else if (typeof n.HORIZONTAL_AXIS < "u" && n.axis === n.HORIZONTAL_AXIS) this.deltaX = -e.detail / 3;
			else if (e.type === "wheel") {
				let t = e;
				t.deltaMode === t.DOM_DELTA_LINE ? Pt && !Zt ? this.deltaX = -e.deltaX / 3 : this.deltaX = -e.deltaX : this.deltaX = -e.deltaX / 40;
			}
...
((e) => {
	function t(t) {
		return t === e.None || t === e.Cancelled || t instanceof On ? !0 : !t || typeof t != "object" ? !1 : typeof t.isCancellationRequested == "boolean" && typeof t.onCancellationRequested == "function";
	}
...
var On = class {
	...
	get onCancellationRequested() {
		return this._isCancelled ? En : (this._emitter ||= new M(), this._emitter.event);
	}
	dispose() {
	...
	cancelAndSet(e, t) {
		if (this._isDisposed) throw new Ie("Calling 'cancelAndSet' on a disposed TimeoutTimer");
		this.cancel(), this._token = setTimeout(() => {
			this._token = -1, e();
		}, t);
	}
	setIfNotSet(e, t) {
		if (this._isDisposed) throw new Ie("Calling 'setIfNotSet' on a disposed TimeoutTimer");
	...
	cancelAndSet(e, t, n = globalThis) {
		if (this.isDisposed) throw new Ie("Calling 'cancelAndSet' on a disposed IntervalTimer");
		this.cancel();
		let r = n.setInterval(() => {
			e();
		}, t);
...
var Mn = class e {
	...
	constructor(e, t) {
		this._state = 0, this._results = [], this._error = null, this._onReturn = t, this._onStateChanged = new M(), queueMicrotask(async () => {
			let t = {
...
function Ln(e, t) {
	switch (typeof e) {
		case "object": return e === null ? Rn(349, t) : Array.isArray(e) ? Vn(e, t) : Hn(e, t);
		case "string": return Bn(e, t);
		case "boolean": return zn(e, t);
		case "number": return Rn(e, t);
		case "undefined": return Rn(937, t);
		default: return Rn(617, t);
	}
}
function Rn(e, t) {
	return (t << 5) - t + e | 0;
...
function zn(e, t) {
	return Rn(e ? 433 : 863, t);
}
function Bn(e, t) {
	t = Rn(149417, t);
	for (let n = 0, r = e.length; n < r; n++) t = Rn(e.charCodeAt(n), t);
	return t;
}
function Vn(e, t) {
	return t = Rn(104579, t), e.reduce((e, t) => Ln(t, e), t);
}
function Hn(e, t) {
	return t = Rn(181387, t), Object.keys(e).sort().reduce((t, n) => (t = Bn(n, t), Ln(e[n], t)), t);
}
function Un(e, t, n = 32) {
	let r = n - t, i = ~((1 << r) - 1);
	return (e << t | (i & e) >>> r) >>> 0;
}
function Wn(e, t = 0, n = e.byteLength, r = 0) {
...
function Kn(e, t = 32) {
	return e instanceof ArrayBuffer ? Array.from(new Uint8Array(e)).map((e) => e.toString(16).padStart(2, "0")).join("") : Gn((e >>> 0).toString(16), t / 4);
}
var qn = class e {
	constructor() {
	...
	digest() {
		return this._finished || (this._finished = !0, this._leftoverHighSurrogate && (this._leftoverHighSurrogate = 0, this._buffLen = this._push(this._buff, this._buffLen, 65533)), this._totalLen += this._buffLen, this._wrapUp()), Kn(this._h0) + Kn(this._h1) + Kn(this._h2) + Kn(this._h3) + Kn(this._h4);
	}
	_wrapUp() {
		this._buff[this._buffLen++] = 128, Wn(this._buff, this._buffLen), this._buffLen > 56 && (this._step(), Wn(this._buff));
	...
	_step() {
		...
		for (let e = 64; e < 320; e += 4) t.setUint32(e, Un(t.getUint32(e - 12, !1) ^ t.getUint32(e - 32, !1) ^ t.getUint32(e - 56, !1) ^ t.getUint32(e - 64, !1), 1), !1);
		let r = this._h0, i = this._h1, a = this._h2, o = this._h3, s = this._h4, c, l, u;
		for (let e = 0; e < 80; e++) e < 20 ? (c = i & a | ~i & o, l = 1518500249) : e < 40 ? (c = i ^ a ^ o, l = 1859775393) : e < 60 ? (c = i & a | i & o | a & o, l = 2400959708) : (c = i ^ a ^ o, l = 3395469782), u = Un(r, 5) + c + s + l + t.getUint32(e * 4, !1) & 4294967295, s = o, o = a, a = Un(i, 30), i = r, r = u;
...
qn._bigBlock32 = /* @__PURE__ */ new DataView(/* @__PURE__ */ new ArrayBuffer(320));
var { registerWindow: Jn, getWindow: Yn, getDocument: Xn, getWindows: Zn, getWindowsCount: Qn, getWindowId: $n, getWindowById: er, hasWindow: tr, onDidRegisterWindow: nr, onWillUnregisterWindow: rr, onDidUnregisterWindow: ir } = function() {
	let e = /* @__PURE__ */ new Map(), t = {
		window: st,
		disposables: new at()
	};
	e.set(st.vscodeWindowId, t);
	let n = new M(), r = new M(), i = new M();
	function a(n, r) {
	...
	return {
		...
		registerWindow(t) {
			if (e.has(t.vscodeWindowId)) return k.None;
			let a = new at(), o = {
				window: t,
				disposables: a.add(new at())
			};
			return e.set(t.vscodeWindowId, o), a.add(O(() => {
				e.delete(t.vscodeWindowId), r.fire(t);
			})), a.add(P(t, F.BEFORE_UNLOAD, () => {
				i.fire(t);
			})), n.fire(o), a;
		},
		getWindows() {
		...
		getWindow(e) {
			...
			let n = e;
			return n?.view ? n.view.window : st;
		},
		getDocument(e) {
...
var cr = function(e, t, n, r) {
	let i = n;
	return t === "click" || t === "mousedown" || t === "contextmenu" ? i = or(Yn(e), n) : (t === "keydown" || t === "keypress" || t === "keyup") && (i = sr(n)), P(e, t, i, r);
}, lr, ur = class extends An {
	constructor(e) {
		super(), this.defaultTarget = e && Yn(e);
	}
	cancelAndSet(e, t, n) {
...
(function() {
	let e = /* @__PURE__ */ new Map(), t = /* @__PURE__ */ new Map(), n = /* @__PURE__ */ new Map(), r = /* @__PURE__ */ new Map(), i = (i) => {
		n.set(i, !1);
		let a = e.get(i) ?? [];
		for (t.set(i, a), e.set(i, []), r.set(i, !0); a.length > 0;) a.sort(dr.sort), a.shift().execute();
		r.set(i, !1);
	};
	lr = (t, r, a = 0) => {
		let o = $n(t), s = new dr(r, a), c = e.get(o);
...
fr.None = new fr(0, 0);
function pr(e) {
	let t = e.getBoundingClientRect(), n = Yn(e);
	return {
...
new class {
	...
	observe(e, t, n) {
		...
		let i = In(n), a = r.get(i);
		if (a) a.users += 1;
		else {
			let o = new M(), s = new MutationObserver((e) => o.fire(e));
			s.observe(e, n);
			let c = a = {
				users: 1,
				observer: s,
...
var F = {
	...
	DROP: "drop",
	DRAG_END: "dragend",
	ANIMATION_START: Ft ? "webkitAnimationStart" : "animationstart",
	ANIMATION_END: Ft ? "webkitAnimationEnd" : "animationend",
	ANIMATION_ITERATION: Ft ? "webkitAnimationIteration" : "animationiteration"
}, mr = /([\w\-]+)?(#([\w\-]+))?((\.([\w\-]+))*)/;
function hr(e, t, n, ...r) {
	let i = mr.exec(t);
...
function gr(e, t, ...n) {
	return hr("http://www.w3.org/1999/xhtml", e, t, ...n);
}
gr.SVG = function(e, t, ...n) {
	return hr("http://www.w3.org/2000/svg", e, t, ...n);
};
var _r = class {
	constructor(e) {
...
var yr = class {
	constructor() {
		this._hooks = new at(), this._pointerMoveCallback = null, this._onStopCallback = null;
	}
	dispose() {
	...
	startMonitoring(e, t, n, r, i) {
		...
		this._hooks.add(P(a, F.POINTER_MOVE, (e) => {
			if (e.buttons !== n) {
				this.stopMonitoring(!0);
				return;
			}
			e.preventDefault(), this._pointerMoveCallback(e);
		})), this._hooks.add(P(a, F.POINTER_UP, (e) => this.stopMonitoring(!0)));
	}
};
function br(e, t, n) {
	let r = null, i = null;
...
var xr;
((e) => (e.Tap = "-xterm-gesturetap", e.Change = "-xterm-gesturechange", e.Start = "-xterm-gesturestart", e.End = "-xterm-gesturesend", e.Contextmenu = "-xterm-gesturecontextmenu"))(xr ||= {});
var Sr = class e extends k {
	constructor() {
		super(), this.dispatched = !1, this.targets = new lt(), this.ignoreTargets = new lt(), this.activeTouches = {}, this.handle = null, this._lastSetTapCountTime = 0, this._register(j.runAndSubscribe(nr, ({ window: e, disposables: t }) => {
			t.add(P(e.document, "touchstart", (e) => this.onTouchStart(e), { passive: !1 })), t.add(P(e.document, "touchend", (t) => this.onTouchEnd(e, t))), t.add(P(e.document, "touchmove", (e) => this.onTouchMove(e), { passive: !1 }));
		}, {
			window: st,
	...
	static addTarget(t) {
		return e.isTouchDevice() ? (e.INSTANCE ||= tt(new e()), O(e.INSTANCE.targets.push(t))) : k.None;
	}
	static ignoreTarget(t) {
		return e.isTouchDevice() ? (e.INSTANCE ||= tt(new e()), O(e.INSTANCE.ignoreTargets.push(t))) : k.None;
	}
	static isTouchDevice() {
		return "ontouchstart" in st || navigator.maxTouchPoints > 0;
	}
	dispose() {
	...
	onTouchStart(e) {
		...
		for (let n = 0, r = e.targetTouches.length; n < r; n++) {
			...
			let i = this.newGestureEvent(xr.Start, r.target);
	...
	onTouchEnd(t, n) {
		...
		for (let a = 0, o = n.changedTouches.length; a < o; a++) {
			...
			if (c < e.HOLD_DELAY && Math.abs(s.initialPageX - D(s.rollingPageX)) < 30 && Math.abs(s.initialPageY - D(s.rollingPageY)) < 30) {
				let e = this.newGestureEvent(xr.Tap, s.initialTarget);
				e.pageX = D(s.rollingPageX), e.pageY = D(s.rollingPageY), this.dispatchEvent(e);
			} else if (c >= e.HOLD_DELAY && Math.abs(s.initialPageX - D(s.rollingPageX)) < 30 && Math.abs(s.initialPageY - D(s.rollingPageY)) < 30) {
				let e = this.newGestureEvent(xr.Contextmenu, s.initialTarget);
				e.pageX = D(s.rollingPageX), e.pageY = D(s.rollingPageY), this.dispatchEvent(e);
			} else if (i === 1) {
				let e = D(s.rollingPageX), n = D(s.rollingPageY), i = D(s.rollingTimestamps) - s.rollingTimestamps[0], a = e - s.rollingPageX[0], o = n - s.rollingPageY[0], c = [...this.targets].filter((e) => s.initialTarget instanceof Node && e.contains(s.initialTarget));
				this.inertia(t, c, r, Math.abs(a) / i, a > 0 ? 1 : -1, e, Math.abs(o) / i, o > 0 ? 1 : -1, n);
			}
			this.dispatchEvent(this.newGestureEvent(xr.End, s.initialTarget)), delete this.activeTouches[o.identifier];
		}
	...
	dispatchEvent(t) {
		...
		} else (t.type === xr.Change || t.type === xr.Contextmenu) && (this._lastSetTapCountTime = 0);
	...
	inertia(t, n, r, i, a, o, s, c, l) {
		this.handle = lr(t, () => {
			...
			let h = this.newGestureEvent(xr.Change);
	...
	onTouchMove(e) {
		...
		for (let n = 0, r = e.changedTouches.length; n < r; n++) {
			...
			let i = this.activeTouches[r.identifier], a = this.newGestureEvent(xr.Change, i.initialTarget);
...
Sr.SCROLL_FRICTION = -.005, Sr.HOLD_DELAY = 700, Sr.CLEAR_TAP_COUNT_TIME = 400, c([br], Sr, "isTouchDevice", 1);
var Cr = Sr, wr = class extends k {
	onclick(e, t) {
		this._register(P(e, F.CLICK, (n) => t(new wn(Yn(e), n))));
	}
	onmousedown(e, t) {
		this._register(P(e, F.MOUSE_DOWN, (n) => t(new wn(Yn(e), n))));
	}
	onmouseover(e, t) {
		this._register(P(e, F.MOUSE_OVER, (n) => t(new wn(Yn(e), n))));
	}
	onmouseleave(e, t) {
		this._register(P(e, F.MOUSE_LEAVE, (n) => t(new wn(Yn(e), n))));
	}
	onkeydown(e, t) {
		this._register(P(e, F.KEY_DOWN, (e) => t(new bn(e))));
	}
	onkeyup(e, t) {
		this._register(P(e, F.KEY_UP, (e) => t(new bn(e))));
	}
	oninput(e, t) {
		this._register(P(e, F.INPUT, t));
	}
	onblur(e, t) {
		this._register(P(e, F.BLUR, t));
	}
	onfocus(e, t) {
		this._register(P(e, F.FOCUS, t));
	}
	onchange(e, t) {
		this._register(P(e, F.CHANGE, t));
	}
	ignoreGesture(e) {
		return Cr.ignoreTarget(e);
	}
}, Tr = 11, Er = class extends wr {
	constructor(e) {
		super(), this._onActivate = e.onActivate, this.bgDomNode = document.createElement("div"), this.bgDomNode.className = "arrow-background", this.bgDomNode.style.position = "absolute", this.bgDomNode.style.width = e.bgWidth + "px", this.bgDomNode.style.height = e.bgHeight + "px", typeof e.top < "u" && (this.bgDomNode.style.top = "0px"), typeof e.left < "u" && (this.bgDomNode.style.left = "0px"), typeof e.bottom < "u" && (this.bgDomNode.style.bottom = "0px"), typeof e.right < "u" && (this.bgDomNode.style.right = "0px"), this.domNode = document.createElement("div"), this.domNode.className = e.className, this.domNode.style.position = "absolute", this.domNode.style.width = Tr + "px", this.domNode.style.height = Tr + "px", typeof e.top < "u" && (this.domNode.style.top = e.top + "px"), typeof e.left < "u" && (this.domNode.style.left = e.left + "px"), typeof e.bottom < "u" && (this.domNode.style.bottom = e.bottom + "px"), typeof e.right < "u" && (this.domNode.style.right = e.right + "px"), this._pointerMoveMonitor = this._register(new yr()), this._register(cr(this.bgDomNode, F.POINTER_DOWN, (e) => this._arrowPointerDown(e))), this._register(cr(this.domNode, F.POINTER_DOWN, (e) => this._arrowPointerDown(e))), this._pointerdownRepeatTimer = this._register(new ur()), this._pointerdownScheduleRepeatTimer = this._register(new kn());
	}
	_arrowPointerDown(e) {
		!e.target || !(e.target instanceof Element) || (this._onActivate(), this._pointerdownRepeatTimer.cancel(), this._pointerdownScheduleRepeatTimer.cancelAndSet(() => {
			this._pointerdownRepeatTimer.cancelAndSet(() => this._onActivate(), 1e3 / 24, Yn(e));
	...
	constructor(e) {
		super(), this._scrollableBrand = void 0, this._onScroll = this._register(new M()), this.onScroll = this._onScroll.event, this._smoothScrollDuration = e.smoothScrollDuration, this._scheduleAtNextAnimationFrame = e.scheduleAtNextAnimationFrame, this._state = new Dr(e.forceIntegerValues, 0, 0, 0, 0, 0, 0), this._smoothScrolling = null;
	}
	dispose() {
	...
	setScrollPositionSmooth(e, t) {
		...
		if (this._smoothScrolling) {
			...
			let r;
			r = t ? new Mr(this._smoothScrolling.from, n, this._smoothScrolling.startTime, this._smoothScrolling.duration) : this._smoothScrolling.combine(this._state, n, this._smoothScrollDuration), this._smoothScrolling.dispose(), this._smoothScrolling = r;
		} else {
			let t = this._state.withScrollPosition(e);
			this._smoothScrolling = Mr.start(this._state, t, this._smoothScrollDuration);
		}
...
var Mr = class e {
	...
	_initAnimation(e, t, n) {
		if (Math.abs(e - t) > 2.5 * n) {
			let r, i;
			return e < t ? (r = e + .75 * n, i = t - .75 * n) : (r = e - .75 * n, i = t + .75 * n), jr(Ar(e, r), Ar(i, t), .33);
		}
		return Ar(e, t);
	}
	dispose() {
	...
	_tick(e) {
		...
		return t < 1 ? new kr(this.scrollLeft(t), this.scrollTop(t), !1) : new kr(this.to.scrollLeft, this.to.scrollTop, !0);
	}
	combine(t, n, r) {
...
var Fr = class extends k {
	constructor(e, t, n) {
		super(), this._visibility = e, this._visibleClassName = t, this._invisibleClassName = n, this._domNode = null, this._isVisible = !1, this._isNeeded = !1, this._rawShouldBeVisible = !1, this._shouldBeVisible = !1, this._revealTimer = this._register(new kn());
	}
	setVisibility(e) {
...
}, Ir = 140, Lr = class extends wr {
	constructor(e) {
		super(), this._lazyRender = e.lazyRender, this._host = e.host, this._scrollable = e.scrollable, this._scrollByPage = e.scrollByPage, this._scrollbarState = e.scrollbarState, this._visibilityController = this._register(new Fr(e.visibility, "visible scrollbar " + e.extraScrollbarClassName, "invisible scrollbar " + e.extraScrollbarClassName)), this._visibilityController.setIsNeeded(this._scrollbarState.isNeeded()), this._pointerMoveMonitor = this._register(new yr()), this._shouldRender = !0, this.domNode = vr(document.createElement("div")), this.domNode.setAttribute("role", "presentation"), this.domNode.setAttribute("aria-hidden", "true"), this._visibilityController.setDomNode(this.domNode), this.domNode.setPosition("absolute"), this._register(P(this.domNode.domNode, F.POINTER_DOWN, (e) => this._domNodePointerDown(e)));
	}
	_createArrow(e) {
		let t = this._register(new Er(e));
		this.domNode.domNode.appendChild(t.bgDomNode), this.domNode.domNode.appendChild(t.domNode);
	}
	_createSlider(e, t, n, r) {
		this.slider = vr(document.createElement("div")), this.slider.setClassName("slider"), this.slider.setPosition("absolute"), this.slider.setTop(e), this.slider.setLeft(t), typeof n == "number" && this.slider.setWidth(n), typeof r == "number" && this.slider.setHeight(r), this.slider.setLayerHinting(!0), this.slider.setContain("strict"), this.domNode.domNode.appendChild(this.slider.domNode), this._register(P(this.slider.domNode, F.POINTER_DOWN, (e) => {
	...
	constructor(e, t, n) {
		...
		if (super({
			...
			host: n,
			scrollbarState: new Rr(t.horizontalHasArrows ? t.arrowSize : 0, t.horizontal === 2 ? 0 : t.horizontalScrollbarSize, t.vertical === 2 ? 0 : t.verticalScrollbarSize, r.width, r.scrollWidth, i.scrollLeft),
	...
	constructor(e, t, n) {
		...
		if (super({
			lazyRender: t.lazyRender,
			host: n,
			scrollbarState: new Rr(t.verticalHasArrows ? t.arrowSize : 0, t.vertical === 2 ? 0 : t.verticalScrollbarSize, 0, r.height, r.scrollHeight, i.scrollTop),
...
Gr.INSTANCE = new Gr();
var Kr = Gr, qr = class extends wr {
	constructor(e, t, n) {
		super(), this._onScroll = this._register(new M()), this.onScroll = this._onScroll.event, this._onWillScroll = this._register(new M()), this.onWillScroll = this._onWillScroll.event, this._options = Yr(t), this._scrollable = n, this._register(this._scrollable.onScroll((e) => {
	...
	delegateScrollFromMouseWheelEvent(e) {
		this._onMouseWheel(new Tn(e));
	}
	_setListeningToMouseWheel(e) {
		this._mouseWheelToDispose.length > 0 !== e && (this._mouseWheelToDispose = nt(this._mouseWheelToDispose), e) && this._mouseWheelToDispose.push(P(this._listenOnDomNode, F.MOUSE_WHEEL, (e) => {
			this._onMouseWheel(new Tn(e));
		}, { passive: !1 }));
	}
	_onMouseWheel(e) {
		...
		let t = Kr.INSTANCE;
		Ur && t.acceptStandardWheelEvent(e);
		let n = !1;
		if (e.deltaY || e.deltaX) {
			...
			let a = !Zt && e.browserEvent && e.browserEvent.shiftKey;
			...
			if (r) {
				let e = Hr * r, t = o.scrollTop - (e < 0 ? Math.floor(e) : Math.ceil(e));
				this._verticalScrollbar.writeScrollPosition(s, t);
			}
			if (i) {
				let e = Hr * i, t = o.scrollLeft - (e < 0 ? Math.floor(e) : Math.ceil(e));
				this._horizontalScrollbar.writeScrollPosition(s, t);
			}
			s = this._scrollable.validateScrollPosition(s), (o.scrollLeft !== s.scrollLeft || o.scrollTop !== s.scrollTop) && (Ur && this._options.mouseWheelSmoothScroll && t.isPhysicalMouseWheel() ? this._scrollable.setScrollPositionSmooth(s) : this._scrollable.setScrollPositionNow(s), n = !0);
		}
		let r = n;
	...
	_scheduleHide() {
		!this._mouseIsOver && !this._isDragging && this._hideTimeout.cancelAndSet(() => this._hide(), Vr);
	}
}, Jr = class extends qr {
	constructor(e, t, n) {
		super(e, t, n);
...
var Xr = class extends k {
	constructor(e, t, n, r, i, a, o, s) {
		super(), this._bufferService = n, this._optionsService = o, this._renderService = s, this._onRequestScrollLines = this._register(new M()), this.onRequestScrollLines = this._onRequestScrollLines.event, this._isSyncing = !1, this._isHandlingScroll = !1, this._suppressOnScrollHandler = !1;
		let c = this._register(new Or({
			forceIntegerValues: !1,
			smoothScrollDuration: this._optionsService.rawOptions.smoothScrollDuration,
			scheduleAtNextAnimationFrame: (e) => lr(r.window, e)
		}));
		this._register(this._optionsService.onSpecificOptionChange("smoothScrollDuration", () => {
		...
		})), this._scrollableElement = this._register(new Jr(t, {
			vertical: 1,
			horizontal: 2,
			useShadows: !1,
			...
			height: 0,
			scrollHeight: 0
		}), this._register(j.runAndSubscribe(a.onChangeColors, () => {
			this._scrollableElement.getDomNode().style.backgroundColor = a.colors.background.css;
		})), e.appendChild(this._scrollableElement.getDomNode()), this._register(O(() => this._scrollableElement.getDomNode().remove())), this._styleElement = r.mainDocument.createElement("style"), t.appendChild(this._styleElement), this._register(O(() => this._styleElement.remove())), this._register(j.runAndSubscribe(a.onChangeColors, () => {
...
var Zr = class extends k {
	constructor(e, t, n, r, i) {
		...
		})), this._register(this._decorationService.onDecorationRegistered(() => this._queueRefresh())), this._register(this._decorationService.onDecorationRemoved((e) => this._removeDecoration(e))), this._register(O(() => {
...
var Qr = class {
	...
	_refreshDrawConstants() {
		...
		ei.full = this._canvas.width, ei.left = e, ei.center = t, ei.right = e, this._refreshDrawHeightConstants(), ti.full = 1, ti.left = 1, ti.center = 1 + ei.left, ti.right = 1 + ei.left + ei.center;
	}
	_refreshDrawHeightConstants() {
		$r.full = Math.round(2 * this._coreBrowserService.dpr);
		...
		$r.left = t, $r.center = t, $r.right = t;
	}
	_refreshColorZonePadding() {
		this._colorZoneStore.setPadding({
			full: Math.floor(this._bufferService.buffers.active.lines.length / (this._canvas.height - 1) * $r.full),
			left: Math.floor(this._bufferService.buffers.active.lines.length / (this._canvas.height - 1) * $r.left),
			center: Math.floor(this._bufferService.buffers.active.lines.length / (this._canvas.height - 1) * $r.center),
			right: Math.floor(this._bufferService.buffers.active.lines.length / (this._canvas.height - 1) * $r.right)
	...
	_renderColorZone(e) {
		this._ctx.fillStyle = e.color, this._ctx.fillRect(ti[e.position || "full"], Math.round((this._canvas.height - 1) * (e.startBufferLine / this._bufferService.buffers.active.lines.length) - $r[e.position || "full"] / 2), ei[e.position || "full"], Math.round((this._canvas.height - 1) * ((e.endBufferLine - e.startBufferLine) / this._bufferService.buffers.active.lines.length) + $r[e.position || "full"]));
	}
	_queueRefresh(e, t) {
...
var L;
((e) => (e.NUL = "\0", e.SOH = "", e.STX = "", e.ETX = "", e.EOT = "", e.ENQ = "", e.ACK = "", e.BEL = "\x07", e.BS = "\b", e.HT = "	", e.LF = "\n", e.VT = "\v", e.FF = "\f", e.CR = "\r", e.SO = "", e.SI = "", e.DLE = "", e.DC1 = "", e.DC2 = "", e.DC3 = "", e.DC4 = "", e.NAK = "", e.SYN = "", e.ETB = "", e.CAN = "", e.EM = "", e.SUB = "", e.ESC = "\x1B", e.FS = "", e.GS = "", e.RS = "", e.US = "", e.SP = " ", e.DEL = ""))(L ||= {});
var ri;
((e) => (e.PAD = "", e.HOP = "", e.BPH = "", e.NBH = "", e.IND = "", e.NEL = "", e.SSA = "", e.ESA = "", e.HTS = "", e.HTJ = "", e.VTS = "", e.PLD = "", e.PLU = "", e.RI = "", e.SS2 = "", e.SS3 = "", e.DCS = "", e.PU1 = "", e.PU2 = "", e.STS = "", e.CCH = "", e.MW = "", e.SPA = "", e.EPA = "", e.SOS = "", e.SGCI = "", e.SCI = "", e.CSI = "", e.ST = "", e.OSC = "", e.PM = "", e.APC = ""))(ri ||= {});
var ii;
((e) => e.ST = `${L.ESC}\\`)(ii ||= {});
var ai = class {
	constructor(e, t, n, r, i, a) {
	...
	_handleAnyTextareaChanges() {
		...
		setTimeout(() => {
			if (!this._isComposing) {
				...
				this._dataAlreadySent = n, t.length > e.length ? this._coreService.triggerDataEvent(n, !0) : t.length < e.length ? this._coreService.triggerDataEvent(`${L.DEL}`, !0) : t.length === e.length && t !== e && this._coreService.triggerDataEvent(t, !0);
			}
		}, 0);
	}
...
var R = 0, z = 0, B = 0, V = 0, oi = {
	css: "#00000000",
	rgba: 0
}, H;
((e) => {
	function t(e, t, n, r) {
		return r === void 0 ? `#${ci(e)}${ci(t)}${ci(n)}` : `#${ci(e)}${ci(t)}${ci(n)}${ci(r)}`;
	}
	e.toCss = t;
...
((e) => {
	function t(e, t) {
		if (V = (t.rgba & 255) / 255, V === 1) return {
			css: t.css,
			rgba: t.rgba
		};
		let n = t.rgba >> 24 & 255, r = t.rgba >> 16 & 255, i = t.rgba >> 8 & 255, a = e.rgba >> 24 & 255, o = e.rgba >> 16 & 255, s = e.rgba >> 8 & 255;
		return R = a + Math.round((n - a) * V), z = o + Math.round((r - o) * V), B = s + Math.round((i - s) * V), {
			css: H.toCss(R, z, B),
			rgba: H.toRgba(R, z, B)
		};
	}
	...
	e.isOpaque = n;
	function r(e, t, n) {
		let r = si.ensureContrastRatio(e.rgba, t.rgba, n);
		if (r) return H.toColor(r >> 24 & 255, r >> 16 & 255, r >> 8 & 255);
	}
	e.ensureContrastRatio = r;
	function i(e) {
		let t = (e.rgba | 255) >>> 0;
		return [R, z, B] = si.toChannels(t), {
			css: H.toCss(R, z, B),
			rgba: t
		};
	}
	e.opaque = i;
	function a(e, t) {
		return V = Math.round(t * 255), [R, z, B] = si.toChannels(e.rgba), {
			css: H.toCss(R, z, B, V),
			rgba: H.toRgba(R, z, B, V)
		};
	}
	e.opacity = a;
	function o(e, t) {
		return V = e.rgba & 255, a(e, V * t / 255);
	}
	e.multiplyOpacity = o;
	function s(e) {
		return [
...
((e) => {
	...
	function r(e) {
		if (e.match(/#[\da-f]{3,8}/i)) switch (e.length) {
			case 4: return R = parseInt(e.slice(1, 2).repeat(2), 16), z = parseInt(e.slice(2, 3).repeat(2), 16), B = parseInt(e.slice(3, 4).repeat(2), 16), H.toColor(R, z, B);
			case 5: return R = parseInt(e.slice(1, 2).repeat(2), 16), z = parseInt(e.slice(2, 3).repeat(2), 16), B = parseInt(e.slice(3, 4).repeat(2), 16), V = parseInt(e.slice(4, 5).repeat(2), 16), H.toColor(R, z, B, V);
			case 7: return {
				css: e,
		...
		if (r) return R = parseInt(r[1]), z = parseInt(r[2]), B = parseInt(r[3]), V = Math.round((r[5] === void 0 ? 1 : parseFloat(r[5])) * 255), H.toColor(R, z, B, V);
		if (!t || !n || (t.fillStyle = n, t.fillStyle = e, typeof t.fillStyle != "string") || (t.fillRect(0, 0, 1, 1), [R, z, B, V] = t.getImageData(0, 0, 1, 1).data, V !== 255)) throw Error("css.toColor: Unsupported css format");
		return {
			rgba: H.toRgba(R, z, B, V),
			css: e
		};
...
((e) => {
	function t(e, t) {
		if (V = (t & 255) / 255, V === 1) return t;
		let n = t >> 24 & 255, r = t >> 16 & 255, i = t >> 8 & 255, a = e >> 24 & 255, o = e >> 16 & 255, s = e >> 8 & 255;
		return R = a + Math.round((n - a) * V), z = o + Math.round((r - o) * V), B = s + Math.round((i - s) * V), H.toRgba(R, z, B);
	}
	e.blend = t;
	function n(e, t, n) {
		let a = G.relativeLuminance(e >> 8), o = G.relativeLuminance(t >> 8);
		if (li(a, o) < n) {
			if (o < a) {
				let o = r(e, t, n), s = li(a, G.relativeLuminance(o >> 8));
				if (s < n) {
					let r = i(e, t, n);
					return s > li(a, G.relativeLuminance(r >> 8)) ? o : r;
				}
				return o;
			}
			let s = i(e, t, n), c = li(a, G.relativeLuminance(s >> 8));
			if (c < n) {
				let i = r(e, t, n);
				return c > li(a, G.relativeLuminance(i >> 8)) ? s : i;
			}
			return s;
		}
	}
	...
	function r(e, t, n) {
		let r = e >> 24 & 255, i = e >> 16 & 255, a = e >> 8 & 255, o = t >> 24 & 255, s = t >> 16 & 255, c = t >> 8 & 255, l = li(G.relativeLuminance2(o, s, c), G.relativeLuminance2(r, i, a));
		for (; l < n && (o > 0 || s > 0 || c > 0);) o -= Math.max(0, Math.ceil(o * .1)), s -= Math.max(0, Math.ceil(s * .1)), c -= Math.max(0, Math.ceil(c * .1)), l = li(G.relativeLuminance2(o, s, c), G.relativeLuminance2(r, i, a));
		return (o << 24 | s << 16 | c << 8 | 255) >>> 0;
	}
	e.reduceLuminance = r;
	function i(e, t, n) {
		let r = e >> 24 & 255, i = e >> 16 & 255, a = e >> 8 & 255, o = t >> 24 & 255, s = t >> 16 & 255, c = t >> 8 & 255, l = li(G.relativeLuminance2(o, s, c), G.relativeLuminance2(r, i, a));
		for (; l < n && (o < 255 || s < 255 || c < 255);) o = Math.min(255, o + Math.ceil((255 - o) * .1)), s = Math.min(255, s + Math.ceil((255 - s) * .1)), c = Math.min(255, c + Math.ceil((255 - c) * .1)), l = li(G.relativeLuminance2(o, s, c), G.relativeLuminance2(r, i, a));
		return (o << 24 | s << 16 | c << 8 | 255) >>> 0;
	}
...
var ui = class extends ce {
	...
	constructor(e) {
		this._bufferService = e, this._characterJoiners = [], this._nextCharacterJoinerId = 0, this._workCell = new y();
	}
	register(e) {
		let t = {
	...
	getJoinedCharacters(e) {
		...
		for (let e = 0; e < t.getTrimmedLength(); e++) if (t.loadCell(e, this._workCell), this._workCell.getWidth() !== 0) {
			...
			a += this._workCell.getChars().length || se.length;
		}
	...
	_getJoinedRanges(e, t, n, r, i) {
		...
		for (let e = 1; e < this._characterJoiners.length; e++) try {
			...
			for (let e = 0; e < t.length; e++) di._mergeRanges(o, t[e]);
		} catch (e) {
			console.error(e);
		}
	...
	_stringRangesToCellRanges(e, t, n) {
		...
		if (o) {
			for (let s = n; s < this._bufferService.cols; s++) {
				let n = t.getWidth(s), c = t.getString(s).length || se.length;
				if (n !== 0) {
...
var _i = class {
	constructor(e, t, n, r, i, a, o) {
		this._document = e, this._characterJoinerService = t, this._optionsService = n, this._coreBrowserService = r, this._coreService = i, this._decorationService = a, this._themeService = o, this._workCell = new y(), this._columnSelectMode = !1, this.defaultSpacing = 0;
	}
	...
	createRow(e, t, n, r, i, a, o, s, c, l, u) {
		...
		n && m < a + 1 && (m = a + 1);
		let h, g = 0, _ = "", v = 0, ee = 0, te = 0, ne = 0, re = !1, ie = 0, ae = !1, oe = 0, le = 0, y = [], ue = l !== -1 && u !== -1;
		for (let b = 0; b < m; b++) {
			e.loadCell(b, this._workCell);
			let m = this._workCell.getWidth();
			if (m === 0) continue;
			let de = !1, fe = b >= le, x = b, S = this._workCell;
			if (f.length > 0 && b === f[0][0] && fe) {
				let r = f.shift(), i = this._isCellInSelection(r[0], t);
				for (v = r[0] + 1; v < r[1]; v++) fe &&= i === this._isCellInSelection(v, t);
				fe &&= !n || a < r[0] || a >= r[1], fe ? (de = !0, S = new ui(this._workCell, e.translateToString(!0, r[0], r[1]), r[1] - r[0]), x = r[1] - 1, m = S.getWidth()) : le = r[1];
			}
			let C = this._isCellInSelection(b, t), pe = n && b === a, me = ue && b >= l && b <= u, he = !1;
			this._decorationService.forEachDecorationAtCell(b, t, void 0, (e) => {
				he = !0;
			});
			let ge = S.getChars() || se;
			if (ge === " " && (S.isUnderline() || S.isOverline()) && (ge = "\xA0"), oe = m * s - c.get(ge, S.isBold(), S.isItalic()), !h) h = this._document.createElement("span");
			else if (g && (C && ae || !C && !ae && S.bg === ee) && (C && ae && p.selectionForeground || S.fg === te) && S.extended.ext === ne && me === re && oe === ie && !pe && !de && !he && fe) {
				S.isInvisible() ? _ += se : _ += ge, g++;
				continue;
			} else g && (h.textContent = _), h = this._document.createElement("span"), g = 0, _ = "";
			if (ee = S.bg, te = S.fg, ne = S.extended.ext, re = me, ie = oe, ae = C, de && a >= b && a <= x && (a = b), !this._coreService.isCursorHidden && pe && this._coreService.isCursorInitialized) {
			...
			if (S.isBold() && y.push("xterm-bold"), S.isItalic() && y.push("xterm-italic"), S.isDim() && y.push("xterm-dim"), _ = S.isInvisible() ? se : S.getChars() || se, S.isUnderline() && (y.push(`xterm-underline-${S.extended.underlineStyle}`), _ === " " && (_ = "\xA0"), !S.isUnderlineColorDefault())) if (S.isUnderlineColorRGB()) h.style.textDecorationColor = `rgb(${ce.toColorRGB(S.getUnderlineColor()).join(",")})`;
			else {
				let e = S.getUnderlineColor();
				this._optionsService.rawOptions.drawBoldTextInBrightColors && S.isBold() && e < 8 && (e += 8), h.style.textDecorationColor = p.ansi[e].css;
			}
			S.isOverline() && (y.push("xterm-overline"), _ === " " && (_ = "\xA0")), S.isStrikethrough() && y.push("xterm-strikethrough"), me && (h.style.textDecoration = "underline");
			let w = S.getFgColor(), T = S.getFgColorMode(), _e = S.getBgColor(), ve = S.getBgColorMode(), ye = !!S.isInverse();
			if (ye) {
				let e = w;
				w = _e, _e = e;
				let t = T;
			...
			let be, xe, Se = !1;
			this._decorationService.forEachDecorationAtCell(b, t, void 0, (e) => {
				e.options.layer !== "top" && Se || (e.backgroundColorRGB && (ve = 50331648, _e = e.backgroundColorRGB.rgba >> 8 & 16777215, be = e.backgroundColorRGB), e.foregroundColorRGB && (T = 50331648, w = e.foregroundColorRGB.rgba >> 8 & 16777215, xe = e.foregroundColorRGB), Se = e.options.layer === "top");
			}), !Se && C && (be = this._coreBrowserService.isFocused ? p.selectionBackgroundOpaque : p.selectionInactiveBackgroundOpaque, _e = be.rgba >> 8 & 16777215, ve = 50331648, Se = !0, p.selectionForeground && (T = 50331648, w = p.selectionForeground.rgba >> 8 & 16777215, xe = p.selectionForeground)), Se && y.push("xterm-decoration-top");
			let E;
			switch (ve) {
				case 16777216:
				case 33554432:
					E = p.ansi[_e], y.push(`xterm-bg-${_e}`);
					break;
				case 50331648:
					E = H.toColor(_e >> 16, _e >> 8 & 255, _e & 255), this._addStyle(h, `background-color:#${vi((_e >>> 0).toString(16), "0", 6)}`);
					break;
				default: ye ? (E = p.foreground, y.push("xterm-bg-257")) : E = p.background;
			}
			switch (be || S.isDim() && (be = U.multiplyOpacity(E, .5)), T) {
				case 16777216:
				case 33554432:
					S.isBold() && w < 8 && this._optionsService.rawOptions.drawBoldTextInBrightColors && (w += 8), this._applyMinimumContrast(h, E, p.ansi[w], S, be, void 0) || y.push(`xterm-fg-${w}`);
					break;
				case 50331648:
					let e = H.toColor(w >> 16 & 255, w >> 8 & 255, w & 255);
					this._applyMinimumContrast(h, E, e, S, be, xe) || this._addStyle(h, `color:#${vi(w.toString(16), "0", 6)}`);
					break;
				default: this._applyMinimumContrast(h, E, p.foreground, S, be, xe) || ye && y.push("xterm-fg-257");
			}
			y.length &&= (h.className = y.join(" "), 0), !pe && !de && !he && fe ? g++ : h.textContent = _, oe !== this.defaultSpacing && (h.style.letterSpacing = `${oe}px`), d.push(h), b = x;
		}
		return h && g && (h.textContent = _), d;
	}
	_applyMinimumContrast(e, t, n, r, i, a) {
		if (this._optionsService.rawOptions.minimumContrastRatio === 1 || mi(r.getCode())) return !1;
		...
		if (!i && !a && (s = o.getColor(t.rgba, n.rgba)), s === void 0) {
			...
			s = U.ensureContrastRatio(i || t, a || n, e), o.setColor((i || t).rgba, (a || n).rgba, s ?? null);
		}
...
var Si = "xterm-dom-renderer-owner-", Ci = "xterm-rows", wi = "xterm-fg-", Ti = "xterm-bg-", Ei = "xterm-focus", Di = "xterm-selection", Oi = 1, ki = class extends k {
	constructor(e, t, n, r, i, a, o, s, c, l, u, d, f, p) {
		super(), this._terminal = e, this._document = t, this._element = n, this._screenElement = r, this._viewportElement = i, this._helperContainer = a, this._linkifier2 = o, this._charSizeService = c, this._optionsService = l, this._bufferService = u, this._coreService = d, this._coreBrowserService = f, this._themeService = p, this._terminalClass = Oi++, this._rowElements = [], this._selectionRenderModel = xi(), this.onRequestRedraw = this._register(new M()).event, this._rowContainer = this._document.createElement("div"), this._rowContainer.classList.add(Ci), this._rowContainer.style.lineHeight = "normal", this._rowContainer.setAttribute("aria-hidden", "true"), this._refreshRowElements(this._bufferService.cols, this._bufferService.rows), this._selectionContainer = this._document.createElement("div"), this._selectionContainer.classList.add(Di), this._selectionContainer.setAttribute("aria-hidden", "true"), this.dimensions = hi(), this._updateDimensions(), this._register(this._optionsService.onOptionChange(() => this._handleOptionsChanged())), this._register(this._themeService.onChangeColors((e) => this._injectCss(e))), this._injectCss(this._themeService.colors), this._rowFactory = s.createInstance(_i, document), this._element.classList.add(Si + this._terminalClass), this._screenElement.appendChild(this._rowContainer), this._screenElement.appendChild(this._selectionContainer), this._register(this._linkifier2.onShowLinkUnderline((e) => this._handleLinkHover(e))), this._register(this._linkifier2.onHideLinkUnderline((e) => this._handleLinkLeave(e))), this._register(O(() => {
			this._element.classList.remove(Si + this._terminalClass), this._rowContainer.remove(), this._selectionContainer.remove(), this._widthCache.dispose(), this._themeStyleElement.remove(), this._dimensionsStyleElement.remove();
		})), this._widthCache = new yi(this._document, this._helperContainer), this._widthCache.setFont(this._optionsService.rawOptions.fontFamily, this._optionsService.rawOptions.fontSize, this._optionsService.rawOptions.fontWeight, this._optionsService.rawOptions.fontWeightBold), this._setDefaultSpacing();
	}
	_updateDimensions() {
		...
		let t = `${this._terminalSelector} .${Ci} span { display: inline-block; height: 100%; vertical-align: top;}`;
	...
	_injectCss(e) {
		...
		let t = `${this._terminalSelector} .${Ci} { pointer-events: none; color: ${e.foreground.css}; font-family: ${this._optionsService.rawOptions.fontFamily}; font-size: ${this._optionsService.rawOptions.fontSize}px; font-kerning: none; white-space: pre}`;
		t += `${this._terminalSelector} .${Ci} .xterm-dim { color: ${U.multiplyOpacity(e.foreground, .5).css};}`, t += `${this._terminalSelector} span:not(.xterm-bold) { font-weight: ${this._optionsService.rawOptions.fontWeight};}${this._terminalSelector} span.xterm-bold { font-weight: ${this._optionsService.rawOptions.fontWeightBold};}${this._terminalSelector} span.xterm-italic { font-style: italic;}`;
		let n = `blink_underline_${this._terminalClass}`, r = `blink_bar_${this._terminalClass}`, i = `blink_block_${this._terminalClass}`;
		t += `@keyframes ${n} { 50% {  border-bottom-style: hidden; }}`, t += `@keyframes ${r} { 50% {  box-shadow: none; }}`, t += `@keyframes ${i} { 0% {  background-color: ${e.cursor.css};  color: ${e.cursorAccent.css}; } 50% {  background-color: inherit;  color: ${e.cursor.css}; }}`, t += `${this._terminalSelector} .${Ci}.${Ei} .xterm-cursor.xterm-cursor-blink.xterm-cursor-underline { animation: ${n} 1s step-end infinite;}${this._terminalSelector} .${Ci}.${Ei} .xterm-cursor.xterm-cursor-blink.xterm-cursor-bar { animation: ${r} 1s step-end infinite;}${this._terminalSelector} .${Ci}.${Ei} .xterm-cursor.xterm-cursor-blink.xterm-cursor-block { animation: ${i} 1s step-end infinite;}${this._terminalSelector} .${Ci} .xterm-cursor.xterm-cursor-block { background-color: ${e.cursor.css}; color: ${e.cursorAccent.css};}${this._terminalSelector} .${Ci} .xterm-cursor.xterm-cursor-block:not(.xterm-cursor-blink) { background-color: ${e.cursor.css} !important; color: ${e.cursorAccent.css} !important;}${this._terminalSelector} .${Ci} .xterm-cursor.xterm-cursor-outline { outline: 1px solid ${e.cursor.css}; outline-offset: -1px;}${this._terminalSelector} .${Ci} .xterm-cursor.xterm-cursor-bar { box-shadow: ${this._optionsService.rawOptions.cursorWidth}px 0 0 ${e.cursor.css} inset;}${this._terminalSelector} .${Ci} .xterm-cursor.xterm-cursor-underline { border-bottom: 1px ${e.cursor.css}; border-bottom-style: solid; height: calc(100% - 1px);}`, t += `${this._terminalSelector} .${Di} { position: absolute; top: 0; left: 0; z-index: 1; pointer-events: none;}${this._terminalSelector}.focus .${Di} div { position: absolute; background-color: ${e.selectionBackgroundOpaque.css};}${this._terminalSelector} .${Di} div { position: absolute; background-color: ${e.selectionInactiveBackgroundOpaque.css};}`;
		for (let [n, r] of e.ansi.entries()) t += `${this._terminalSelector} .${wi}${n} { color: ${r.css}; }${this._terminalSelector} .${wi}${n}.xterm-dim { color: ${U.multiplyOpacity(r, .5).css}; }${this._terminalSelector} .${Ti}${n} { background-color: ${r.css}; }`;
		t += `${this._terminalSelector} .${wi}257 { color: ${U.opaque(e.background).css}; }${this._terminalSelector} .${wi}257.xterm-dim { color: ${U.multiplyOpacity(U.opaque(e.background), .5).css}; }${this._terminalSelector} .${Ti}257 { background-color: ${e.foreground.css}; }`, this._themeStyleElement.textContent = t;
	}
	_setDefaultSpacing() {
	...
	handleBlur() {
		this._rowContainer.classList.remove(Ei), this.renderRows(0, this._bufferService.rows - 1);
	}
	handleFocus() {
		this._rowContainer.classList.add(Ei), this.renderRows(this._bufferService.buffer.y, this._bufferService.buffer.y);
	}
	handleSelectionChanged(e, t, n) {
...
var Ai = class extends k {
	constructor(e, t, n) {
		super(), this._optionsService = n, this.width = 0, this.height = 0, this._onCharSizeChange = this._register(new M()), this.onCharSizeChange = this._onCharSizeChange.event;
		try {
			this._measureStrategy = this._register(new Ni(this._optionsService));
		} catch {
			this._measureStrategy = this._register(new Mi(e, t, this._optionsService));
		}
...
var ji = class extends k {
	...
	constructor(e, t, n) {
		super(), this._textarea = e, this._window = t, this.mainDocument = n, this._isFocused = !1, this._cachedIsFocused = void 0, this._screenDprMonitor = this._register(new Fi(this._window)), this._onDprChange = this._register(new M()), this.onDprChange = this._onDprChange.event, this._onWindowChange = this._register(new M()), this.onWindowChange = this._onWindowChange.event, this._register(this.onWindowChange((e) => this._screenDprMonitor.setWindow(e))), this._register(j.forward(this._screenDprMonitor.onDprChange, this._onDprChange)), this._register(P(this._textarea, "focus", () => this._isFocused = !0)), this._register(P(this._textarea, "blur", () => this._isFocused = !1));
	}
	get window() {
		return this._window;
	}
	...
	_setWindowResizeListener() {
		this._windowResizeListener.value = P(this._parentWindow, "resize", () => this._setDprAndFireIfDiffers());
	}
...
var zi = class {
	...
	getCoords(e, t, n, r, i) {
		return Ri(window, e, t, n, r, this._charSizeService.hasValidSize, this._renderService.dimensions.css.cell.width, this._renderService.dimensions.css.cell.height, i);
	}
...
var Hi = typeof process < "u" && "title" in process, Ui = Hi ? "node" : navigator.userAgent, Wi = Hi ? "node" : navigator.platform, Gi = Ui.includes("Firefox"), Ki = Ui.includes("Edge"), qi = /^((?!chrome|android).)*safari/i.test(Ui);
function Ji() {
	if (!qi) return 0;
	let e = Ui.match(/Version\/(\d+)/);
...
var Yi = [
	...
	"MacPPC",
	"Mac68K"
].includes(Wi), Xi = Wi === "iPad", Zi = Wi === "iPhone", Qi = [
	"Windows",
	"Win16",
	"Win32",
	"WinCE"
].includes(Wi), $i = Wi.indexOf("Linux") >= 0, ea = /\bCrOS\b/.test(Ui), ta = class {
	constructor() {
...
}, ia = !Hi && "requestIdleCallback" in window ? ra : na, aa = class {
	constructor() {
		this._queue = new ia();
	}
	set(e) {
	...
	_registerIntersectionObserver(e, t) {
		if ("IntersectionObserver" in e) {
			...
			n.observe(t), this._observerDisposable.value = O(() => n.disconnect());
		}
	}
...
function ca(e, t, n, r) {
	...
	if (!n.buffer.hasScrollback) return da(i, a, e, t, n, r) + fa(a, t, n, r) + pa(i, a, e, t, n, r);
	let o;
	if (a === t) return o = i > e ? "D" : "C", ba(Math.abs(i - e), ya(o, r));
	o = a > t ? "D" : "C";
	let s = Math.abs(a - t);
	return ba(ua(a > t ? e : i, n) + (s - 1) * n.cols + 1 + la(a > t ? i : e, n), ya(o, r));
}
function la(e, t) {
	return e - 1;
}
...
function da(e, t, n, r, i, a) {
	return fa(t, r, i, a).length === 0 ? "" : ba(va(e, t, e, t - ha(t, i), !1, i).length, ya("D", a));
}
function fa(e, t, n, r) {
	let i = e - ha(e, n), a = t - ha(t, n);
	return ba(Math.abs(i - a) - ma(e, t, n), ya(_a(e, t), r));
}
function pa(e, t, n, r, i, a) {
	let o;
	o = fa(t, r, i, a).length > 0 ? r - ha(r, i) : t;
	let s = r, c = ga(e, t, n, r, i, a);
	return ba(va(e, o, n, s, c === "C", i).length, ya(c, a));
}
function ma(e, t, n) {
	let r = 0, i = e - ha(e, n), a = t - ha(t, n);
...
function ga(e, t, n, r, i, a) {
	let o;
	return o = fa(n, r, i, a).length > 0 ? r - ha(r, i) : t, e < n && o <= r || e >= n && o < r ? "C" : "D";
}
function _a(e, t) {
	return e > t ? "A" : "B";
}
...
var Ca = 50, wa = 15, Ta = 50, Ea = 500, Da = /* @__PURE__ */ RegExp("\xA0", "g"), Oa = class extends k {
	constructor(e, t, n, r, i, a, o, s, c) {
		super(), this._element = e, this._screenElement = t, this._linkifier = n, this._bufferService = r, this._coreService = i, this._mouseService = a, this._optionsService = o, this._renderService = s, this._coreBrowserService = c, this._dragScrollAmount = 0, this._enabled = !0, this._workCell = new y(), this._mouseDownTimeStamp = 0, this._oldHasSelection = !1, this._oldSelectionStart = void 0, this._oldSelectionEnd = void 0, this._onLinuxMouseSelection = this._register(new M()), this.onLinuxMouseSelection = this._onLinuxMouseSelection.event, this._onRedrawRequest = this._register(new M()), this.onRequestRedraw = this._onRedrawRequest.event, this._onSelectionChange = this._register(new M()), this.onSelectionChange = this._onSelectionChange.event, this._onRequestScrollLines = this._register(new M()), this.onRequestScrollLines = this._onRequestScrollLines.event, this._mouseMoveListener = (e) => this._handleMouseMove(e), this._mouseUpListener = (e) => this._handleMouseUp(e), this._coreService.onUserInput(() => {
			this.hasSelection && this.clearSelection();
		}), this._trimListener = this._bufferService.buffer.lines.onTrim((e) => this._handleTrim(e)), this._register(this._bufferService.buffers.onBufferActivate((e) => this._handleBufferActivate(e))), this.enable(), this._model = new xa(this._bufferService), this._activeSelectionMode = 0, this._register(O(() => {
	...
	get selectionText() {
		...
		return r.map((e) => e.replace(Da, " ")).join(Qi ? "\r\n" : "\n");
	}
	clearSelection() {
		this._model.clearSelection(), this._removeMouseDownListeners(), this.refresh(), this._onSelectionChange.fire();
	}
	refresh(e) {
		this._refreshAnimationFrame ||= this._coreBrowserService.window.requestAnimationFrame(() => this._refresh()), $i && e && this.selectionText.length && this._onLinuxMouseSelection.fire(this.selectionText);
	}
	_refresh() {
	...
	_selectWordAtCursor(e, t) {
		...
		if (n) return this._model.selectionStart = [n.start.x - 1, n.start.y - 1], this._model.selectionStartLength = Sa(n, this._bufferService.cols), this._model.selectionEnd = void 0, !0;
	...
	_getMouseEventScrollAmount(e) {
		let t = Li(this._coreBrowserService.window, e, this._screenElement)[1], n = this._renderService.dimensions.css.canvas.height;
		return t >= 0 && t <= n ? 0 : (t > n && (t -= n), t = Math.min(Math.max(t, -Ca), Ca), t /= Ca, t / Math.abs(t) + Math.round(t * (wa - 1)));
	}
	shouldForceSelection(e) {
		return Yi ? e.altKey && this._optionsService.rawOptions.macOptionClickForcesSelection : e.shiftKey;
	}
	handleMouseDown(e) {
	...
	_addMouseDownListeners() {
		this._screenElement.ownerDocument && (this._screenElement.ownerDocument.addEventListener("mousemove", this._mouseMoveListener), this._screenElement.ownerDocument.addEventListener("mouseup", this._mouseUpListener)), this._dragScrollIntervalTimer = this._coreBrowserService.window.setInterval(() => this._dragScroll(), Ta);
	}
	...
	shouldColumnSelect(e) {
		return e.altKey && !(Yi && this._optionsService.rawOptions.macOptionClickForcesSelection);
	}
	_handleMouseMove(e) {
	...
	_handleMouseUp(e) {
		...
		if (this._removeMouseDownListeners(), this.selectionText.length <= 1 && t < Ea && e.altKey && this._optionsService.rawOptions.altClickMovesCursor) {
			if (this._bufferService.buffer.ybase === this._bufferService.buffer.ydisp) {
				...
				if (t && t[0] !== void 0 && t[1] !== void 0) {
					let e = ca(t[0] - 1, t[1] - 1, this._bufferService, this._coreService.decPrivateModes.applicationCursorKeys);
					this._coreService.triggerDataEvent(e, !0);
				}
			}
	...
	_selectLineAt(e) {
		...
		this._model.selectionStart = [0, t.first], this._model.selectionEnd = void 0, this._model.selectionStartLength = Sa(n, this._bufferService.cols);
	}
};
Oa = c([
	l(3, C),
...
var ka = class {
	...
	constructor() {
		this._color = new ka(), this._css = new ka();
	}
	setCss(e, t, n) {
		this._css.set(e, t, n);
	}
	...
	return e;
})()), ja = W.toColor("#ffffff"), Ma = W.toColor("#000000"), Na = W.toColor("#ffffff"), Pa = Ma, Fa = {
	css: "rgba(255, 255, 255, 0.3)",
	rgba: 4294967117
}, Ia = ja, La = class extends k {
	constructor(e) {
		super(), this._optionsService = e, this._contrastCache = new Aa(), this._halfContrastCache = new Aa(), this._onChangeColors = this._register(new M()), this.onChangeColors = this._onChangeColors.event, this._colors = {
			foreground: ja,
			background: Ma,
			cursor: Na,
			cursorAccent: Pa,
			selectionForeground: void 0,
			selectionBackgroundTransparent: Fa,
			selectionBackgroundOpaque: U.blend(Ma, Fa),
			selectionInactiveBackgroundTransparent: Fa,
			selectionInactiveBackgroundOpaque: U.blend(Ma, Fa),
			scrollbarSliderBackground: U.opacity(ja, .2),
			scrollbarSliderHoverBackground: U.opacity(ja, .4),
			scrollbarSliderActiveBackground: U.opacity(ja, .5),
			overviewRulerBorder: ja,
			ansi: K.slice(),
...
var Ra = class {
	...
	constructor() {
		this._services = new Ra(), this._services.set(ge, this);
	}
	setService(e, t) {
	...
	error: 4,
	off: 5
}, Va = "xterm.js: ", Ha = class extends k {
	constructor(e) {
		super(), this._optionsService = e, this._logLevel = 5, this._updateLogLevel(), this._register(this._optionsService.onSpecificOptionChange("logLevel", () => this._updateLogLevel())), Ua = this;
	}
	get logLevel() {
		return this._logLevel;
	}
	_updateLogLevel() {
		this._logLevel = Ba[this._optionsService.rawOptions.logLevel];
	}
	_evalLazyOptionalParams(e) {
		for (let t = 0; t < e.length; t++) typeof e[t] == "function" && (e[t] = e[t]());
	}
	_log(e, t, n) {
		this._evalLazyOptionalParams(n), e.call(console, (this._optionsService.options.logger ? "" : Va) + t, ...n);
	}
	trace(e, ...t) {
...
Ha = c([l(0, T)], Ha);
var Ua, Wa = class extends k {
	constructor(e) {
		super(), this._maxLength = e, this.onDeleteEmitter = this._register(new M()), this.onDelete = this.onDeleteEmitter.event, this.onInsertEmitter = this._register(new M()), this.onInsert = this.onInsertEmitter.event, this.onTrimEmitter = this._register(new M()), this.onTrim = this.onTrimEmitter.event, this._array = Array(this._maxLength), this._startIndex = 0, this._length = 0;
	}
	get maxLength() {
	...
	loadCell(e, t) {
		return Ga = e * J, t.content = this._data[Ga + 0], t.fg = this._data[Ga + 1], t.bg = this._data[Ga + 2], t.content & 2097152 && (t.combinedData = this._combined[e]), t.bg & 268435456 && (t.extended = this._extendedAttrs[e]), t;
	}
	setCell(e, t) {
	...
	resize(e, t) {
		if (e === this.length) return this._data.length * 4 * Ka < this._data.buffer.byteLength;
		let n = e * J;
		if (e > this.length) {
		...
		return this.length = e, n * 4 * Ka < this._data.buffer.byteLength;
	}
	cleanupMemory() {
		if (this._data.length * 4 * Ka < this._data.buffer.byteLength) {
	...
	translateToString(e, t, n, r) {
		...
		let i = "";
		for (; t < n;) {
			let e = this._data[t * J + 0], n = e & 2097151, a = e & 2097152 ? this._combined[t] : n ? ne(n) : se;
...
function Ja(e, t, n, r, i, a) {
	...
	for (let s = 0; s < e.length - 1; s++) {
		...
		let d = 0, f = Qa(u, d, t), p = 1, m = 0;
		for (; p < u.length;) {
			let e = Qa(u, p, t), r = e - m, a = n - f, o = Math.min(r, a);
...
function Za(e, t, n) {
	let r = [], i = e.map((n, r) => Qa(e, r, t)).reduce((e, t) => e + t), a = 0, o = 0, s = 0;
	for (; s < i;) {
		if (i - s < n) {
			r.push(i - s);
			break;
...
var $a = class e {
	constructor(t) {
		this.line = t, this.isDisposed = !1, this._disposables = [], this._id = e._nextId++, this._onDispose = this.register(new M()), this.onDispose = this._onDispose.event;
	}
	get id() {
		return this._id;
	}
	dispose() {
		this.isDisposed || (this.isDisposed = !0, this.line = -1, this._onDispose.fire(), nt(this._disposables), this._disposables.length = 0);
	}
	register(e) {
...
var no = 4294967295, ro = class {
	constructor(e, t, n) {
		this._hasScrollback = e, this._optionsService = t, this._bufferService = n, this.ydisp = 0, this.ybase = 0, this.y = 0, this.x = 0, this.tabs = {}, this.savedY = 0, this.savedX = 0, this.savedCurAttrData = Y.clone(), this.savedCharset = to, this.markers = [], this._nullCell = y.fromCharData([
			0,
			oe,
			1,
			0
		]), this._whitespaceCell = y.fromCharData([
			0,
			se,
			1,
			32
		]), this._isClearing = !1, this._memoryCleanupQueue = new ia(), this._memoryCleanupPosition = 0, this._cols = this._bufferService.cols, this._rows = this._bufferService.rows, this.lines = new Wa(this._getCorrectBufferLength(this._rows)), this.scrollTop = 0, this.scrollBottom = this._rows - 1, this.setupTabStops();
	}
	getNullCell(e) {
		return e ? (this._nullCell.fg = e.fg, this._nullCell.bg = e.bg, this._nullCell.extended = e.extended) : (this._nullCell.fg = 0, this._nullCell.bg = 0, this._nullCell.extended = new le()), this._nullCell;
	}
	getWhitespaceCell(e) {
		return e ? (this._whitespaceCell.fg = e.fg, this._whitespaceCell.bg = e.bg, this._whitespaceCell.extended = e.extended) : (this._whitespaceCell.fg = 0, this._whitespaceCell.bg = 0, this._whitespaceCell.extended = new le()), this._whitespaceCell;
	}
	getBlankLine(e, t) {
		return new qa(this._bufferService.cols, this.getNullCell(e), t);
	}
	get hasScrollback() {
	...
	clear() {
		this.ydisp = 0, this.ybase = 0, this.y = 0, this.x = 0, this.lines = new Wa(this._getCorrectBufferLength(this._rows)), this.scrollTop = 0, this.scrollBottom = this._rows - 1, this.setupTabStops();
	}
	resize(e, t) {
		...
		if (i > this.lines.maxLength && (this.lines.maxLength = i), this.lines.length > 0) {
			...
			let a = 0;
			if (this._rows < t) for (let r = this._rows; r < t; r++) this.lines.length < t + this.ybase && (this._optionsService.rawOptions.windowsMode || this._optionsService.rawOptions.windowsPty.backend !== void 0 || this._optionsService.rawOptions.windowsPty.buildNumber !== void 0 ? this.lines.push(new qa(e, n)) : this.ybase > 0 && this.lines.length <= this.ybase + this.y + a + 1 ? (this.ybase--, a++, this.ydisp > 0 && this.ydisp--) : this.lines.push(new qa(e, n)));
	...
	_reflowLarger(e, t) {
		let n = this._optionsService.rawOptions.reflowCursorLine, r = Ja(this.lines, this._cols, e, this.ybase + this.y, this.getNullCell(Y), n);
		if (r.length > 0) {
			let n = Ya(this.lines, r);
			Xa(this.lines, n.layout), this._reflowLargerAdjustViewport(e, t, n.countRemoved);
		}
	}
	_reflowLargerAdjustViewport(e, t, n) {
		let r = this.getNullCell(Y), i = n;
		for (; i-- > 0;) this.ybase === 0 ? (this.y > 0 && this.y--, this.lines.length < t && this.lines.push(new qa(e, r))) : (this.ydisp === this.ybase && this.ydisp--, this.ybase--);
	...
	_reflowSmaller(e, t) {
		...
		for (let o = this.lines.length - 1; o >= 0; o--) {
			...
			let l = c[c.length - 1].getTrimmedLength(), u = Za(c, this._cols, e), d = u.length - c.length, f;
			...
			for (; g >= 0;) {
				let e = Math.min(_, h);
				if (c[m] === void 0) break;
				c[m].copyCellsFrom(c[g], _ - e, h - e, e, !0), h -= e, h === 0 && (m--, h = u[m]), _ -= e, _ === 0 && (g--, _ = Qa(c, Math.max(g, 0), this._cols));
			}
	...
	reset() {
		this._normal = new ro(!0, this._optionsService, this._bufferService), this._normal.fillViewportRows(), this._alt = new ro(!1, this._optionsService, this._bufferService), this._activeBuffer = this._normal, this._onBufferActivate.fire({
...
}, ao = 2, oo = 1, so = class extends k {
	constructor(e) {
		super(), this.isUserScrolling = !1, this._onResize = this._register(new M()), this.onResize = this._onResize.event, this._onScroll = this._register(new M()), this.onScroll = this._onScroll.event, this.cols = Math.max(e.rawOptions.cols || 0, ao), this.rows = Math.max(e.rawOptions.rows || 0, oo), this.buffers = this._register(new io(e, this)), this._register(this.buffers.onBufferActivate((e) => {
...
var co = {
	...
	_setupOptions() {
		let e = (e) => {
			if (!(e in co)) throw Error(`No option with key "${e}"`);
	...
	_sanitizeAndValidateOption(e, t) {
		switch (e) {
			case "cursorStyle":
				if (t ||= co[e], !fo(t)) throw Error(`"${t}" is not a valid value for ${e}`);
				break;
			case "wordSeparator":
				t ||= co[e];
				break;
...
function po(e, t = 5) {
	...
	for (let r in e) n[r] = t <= 1 ? e[r] : e[r] && po(e[r], t - 1);
	return n;
}
var mo = Object.freeze({ insertMode: !1 }), ho = Object.freeze({
	...
	constructor(e, t, n) {
		super(), this._bufferService = e, this._logService = t, this._optionsService = n, this.isCursorInitialized = !1, this.isCursorHidden = !1, this._onData = this._register(new M()), this.onData = this._onData.event, this._onUserInput = this._register(new M()), this.onUserInput = this._onUserInput.event, this._onBinary = this._register(new M()), this.onBinary = this._onBinary.event, this._onRequestScrollToBottom = this._register(new M()), this.onRequestScrollToBottom = this._onRequestScrollToBottom.event, this.modes = po(mo), this.decPrivateModes = po(ho);
	}
	reset() {
		this.modes = po(mo), this.decPrivateModes = po(ho);
	}
...
var yo = String.fromCharCode, bo = {
	DEFAULT: (e) => {
		...
		return t[0] > 255 || t[1] > 255 || t[2] > 255 ? "" : `\x1B[M${yo(t[0])}${yo(t[1])}${yo(t[2])}`;
	},
	SGR: (e) => {
		let t = e.action === 0 && e.button !== 4 ? "m" : "M";
		return `\x1B[<${vo(e, !0)};${e.col};${e.row}${t}`;
	},
	SGR_PIXELS: (e) => {
		let t = e.action === 0 && e.button !== 4 ? "m" : "M";
		return `\x1B[<${vo(e, !0)};${e.x};${e.y}${t}`;
	}
}, xo = class extends k {
	constructor(e, t, n) {
		super(), this._bufferService = e, this._coreService = t, this._optionsService = n, this._protocols = {}, this._encodings = {}, this._activeProtocol = "", this._activeEncoding = "", this._lastEvent = null, this._wheelPartialScroll = 0, this._onProtocolChange = this._register(new M()), this.onProtocolChange = this._onProtocolChange.event;
		for (let e of Object.keys(_o)) this.addProtocol(e, _o[e]);
		for (let e of Object.keys(bo)) this.addEncoding(e, bo[e]);
		this.reset();
	}
	addProtocol(e, t) {
		this._protocols[e] = t;
...
var To = class {
	constructor() {
		if (this.version = "6", !Z) {
			...
			for (let e = 0; e < So.length; ++e) Z.fill(0, So[e][0], So[e][1] + 1);
		}
	}
	wcwidth(e) {
		return e < 32 ? 0 : e < 127 ? 1 : e < 65536 ? Z[e] : wo(e, Co) ? 0 : e >= 131072 && e <= 196605 || e >= 196608 && e <= 262141 ? 2 : 1;
	}
	charProperties(e, t) {
		let n = this.wcwidth(e), r = n === 0 && t !== 0;
		if (r) {
			let e = Eo.extractWidth(t);
			e === 0 ? r = !1 : e > n && (n = e);
		}
		return Eo.createPropertyValue(0, n, r);
	}
}, Eo = class e {
	constructor() {
		this._providers = Object.create(null), this._active = "", this._onChange = new M(), this.onChange = this._onChange.event;
		let e = new To();
...
var ko = 2147483647, Ao = 256, jo = class e {
	constructor(e = 32, t = 32) {
		if (this.maxLength = e, this.maxSubParamsLength = t, t > Ao) throw Error("maxSubParamsLength must not be greater than 256");
	...
	addParam(e) {
		...
		this._subParamsIdx[this.length] = this._subParamsLength << 8 | this._subParamsLength, this.params[this.length++] = e > ko ? ko : e;
	}
	addSubParam(e) {
		if (this._digitIsSub = !0, this.length) {
			...
			if (e < -1) throw Error("values lesser than -1 are not allowed");
			this._subParams[this._subParamsLength++] = e > ko ? ko : e, this._subParamsIdx[this.length - 1]++;
		}
	}
	hasSubParams(e) {
	...
	addDigit(e) {
		...
		n[t - 1] = ~r ? Math.min(r * 10 + e, ko) : e;
	}
}, Mo = [], No = class {
	constructor() {
		this._state = 0, this._active = Mo, this._id = -1, this._handlers = Object.create(null), this._handlerFb = () => {}, this._stack = {
			paused: !1,
			loopPosition: 0,
			fallThrough: !1
		};
	...
	dispose() {
		this._handlers = Object.create(null), this._handlerFb = () => {}, this._active = Mo;
	}
	reset() {
		...
		this._stack.paused = !1, this._active = Mo, this._id = -1, this._state = 0;
	}
	_start() {
		if (this._active = this._handlers[this._id] || Mo, !this._active.length) this._handlerFb(this._id, "START");
		else for (let e = this._active.length - 1; e >= 0; e--) this._active[e].start();
	}
	_put(e, t, n) {
		if (!this._active.length) this._handlerFb(this._id, "PUT", re(e, t, n));
	...
	put(e, t, n) {
		...
		if (this._state !== 0) {
			...
			this._active = Mo, this._id = -1, this._state = 0;
		}
	}
}, Po = class {
	constructor(e) {
	...
	put(e, t, n) {
		this._hitLimit || (this._data += re(e, t, n), this._data.length > 1e7 && (this._data = "", this._hitLimit = !0));
	}
	end(e) {
		let t = !1;
	...
	constructor() {
		this._handlers = Object.create(null), this._active = Fo, this._ident = 0, this._handlerFb = () => {}, this._stack = {
			paused: !1,
			loopPosition: 0,
			fallThrough: !1
		};
	...
	dispose() {
		this._handlers = Object.create(null), this._handlerFb = () => {}, this._active = Fo;
	}
	registerHandler(e, t) {
		this._handlers[e] === void 0 && (this._handlers[e] = []);
		let n = this._handlers[e];
	...
	reset() {
		...
		this._stack.paused = !1, this._active = Fo, this._ident = 0;
	}
	hook(e, t) {
		if (this.reset(), this._ident = e, this._active = this._handlers[e] || Fo, !this._active.length) this._handlerFb(this._ident, "HOOK", t);
		else for (let e = this._active.length - 1; e >= 0; e--) this._active[e].hook(t);
	}
	put(e, t, n) {
		if (!this._active.length) this._handlerFb(this._ident, "PUT", re(e, t, n));
		else for (let r = this._active.length - 1; r >= 0; r--) this._active[r].put(e, t, n);
	}
	unhook(e, t = !0) {
		...
		this._active = Fo, this._ident = 0;
	}
}, Lo = new jo();
Lo.addParam(0);
var Ro = class {
	constructor(e) {
		this._handler = e, this._data = "", this._params = Lo, this._hitLimit = !1;
	}
	hook(e) {
		this._params = e.length > 1 || e.params[0] ? e.clone() : Lo, this._data = "", this._hitLimit = !1;
	}
	put(e, t, n) {
		this._hitLimit || (this._data += re(e, t, n), this._data.length > 1e7 && (this._data = "", this._hitLimit = !0));
	}
	unhook(e) {
		let t = !1;
		if (this._hitLimit) t = !1;
		else if (e && (t = this._handler(this._data, this._params), t instanceof Promise)) return t.then((e) => (this._params = Lo, this._data = "", this._hitLimit = !1, e));
		return this._params = Lo, this._data = "", this._hitLimit = !1, t;
	}
}, zo = class {
	constructor(e) {
	...
	let e = new zo(4095), t = Array.apply(null, Array(256)).map((e, t) => t), n = (e, n) => t.slice(e, n), r = n(32, 127), i = n(0, 24);
	...
	return e.addMany(i, 0, 3, 0), e.addMany(i, 1, 3, 1), e.add(127, 1, 0, 1), e.addMany(i, 8, 0, 8), e.addMany(i, 3, 3, 3), e.add(127, 3, 0, 3), e.addMany(i, 4, 3, 4), e.add(127, 4, 0, 4), e.addMany(i, 6, 3, 6), e.addMany(i, 5, 3, 5), e.add(127, 5, 0, 5), e.addMany(i, 2, 3, 2), e.add(127, 2, 0, 2), e.add(93, 1, 4, 8), e.addMany(r, 8, 5, 8), e.add(127, 8, 5, 8), e.addMany([
		...
		24,
		26
	], 13, 14, 0), e.add(Bo, 0, 2, 0), e.add(Bo, 8, 5, 8), e.add(Bo, 6, 0, 6), e.add(Bo, 11, 0, 11), e.add(Bo, 13, 13, 13), e;
}(), Ho = class extends k {
	constructor(e = Vo) {
		super(), this._transitions = e, this._parseStack = {
			...
			transition: 0,
			chunkPos: 0
		}, this.initialState = 0, this.currentState = this.initialState, this._params = new jo(), this._params.addParam(0), this._collect = 0, this.precedingJoinState = 0, this._printHandlerFb = (e, t, n) => {}, this._executeHandlerFb = (e) => {}, this._csiHandlerFb = (e, t) => {}, this._escHandlerFb = (e) => {}, this._errorHandlerFb = (e) => e, this._printHandler = this._printHandlerFb, this._executeHandlers = Object.create(null), this._csiHandlers = Object.create(null), this._escHandlers = Object.create(null), this._register(O(() => {
			this._csiHandlers = Object.create(null), this._executeHandlers = Object.create(null), this._escHandlers = Object.create(null);
		})), this._oscParser = this._register(new No()), this._dcsParser = this._register(new Io()), this._errorHandler = this._errorHandlerFb, this.registerEscHandler({ final: "\\" }, () => !0);
	}
	...
	parse(e, t, n) {
		...
		for (let n = a; n < t; ++n) {
			switch (r = e[n], i = this._transitions.table[this.currentState << 8 | (r < 160 ? r : Bo)], i >> 4) {
				case 2:
					for (let i = n + 1;; ++i) {
						if (i >= t || (r = e[i]) < 32 || r > 126 && r < Bo) {
				...
				case 12:
					...
					break;
				case 13:
					for (let i = n + 1;; ++i) if (i >= t || (r = e[i]) === 24 || r === 26 || r === 27 || r > 127 && r < Bo) {
				...
				case 4:
					...
					break;
				case 5:
					for (let i = n + 1;; i++) if (i >= t || (r = e[i]) < 32 || r > 127 && r < Bo) {
...
}, Uo = /^([\da-f])\/([\da-f])\/([\da-f])$|^([\da-f]{2})\/([\da-f]{2})\/([\da-f]{2})$|^([\da-f]{3})\/([\da-f]{3})\/([\da-f]{3})$|^([\da-f]{4})\/([\da-f]{4})\/([\da-f]{4})$/, Wo = /^[\da-f]+$/;
function Go(e) {
	if (!e) return;
	let t = e.toLowerCase();
	if (t.indexOf("rgb:") === 0) {
	...
	} else if (t.indexOf("#") === 0 && (t = t.slice(1), Wo.exec(t) && [
		3,
		6,
		9,
		12
...
function qo(e, t = 16) {
	let [n, r, i] = e;
	return `rgb:${Ko(n, t)}/${Ko(r, t)}/${Ko(i, t)}`;
}
var Jo = {
	"(": 0,
	")": 1,
...
var Qo = 5e3, $o = 0, es = class extends k {
	constructor(e, t, n, r, i, a, o, s, c = new Ho()) {
		super(), this._bufferService = e, this._charsetService = t, this._coreService = n, this._logService = r, this._optionsService = i, this._oscLinkService = a, this._coreMouseService = o, this._unicodeService = s, this._parser = c, this._parseBuffer = new Uint32Array(4096), this._stringDecoder = new ie(), this._utf8Decoder = new ae(), this._windowTitle = "", this._iconName = "", this._windowTitleStack = [], this._iconNameStack = [], this._curAttrData = Y.clone(), this._eraseAttrDataInternal = Y.clone(), this._onRequestBell = this._register(new M()), this.onRequestBell = this._onRequestBell.event, this._onRequestRefreshRows = this._register(new M()), this.onRequestRefreshRows = this._onRequestRefreshRows.event, this._onRequestReset = this._register(new M()), this.onRequestReset = this._onRequestReset.event, this._onRequestSendFocus = this._register(new M()), this.onRequestSendFocus = this._onRequestSendFocus.event, this._onRequestSyncScrollBar = this._register(new M()), this.onRequestSyncScrollBar = this._onRequestSyncScrollBar.event, this._onRequestWindowsOptionsReport = this._register(new M()), this.onRequestWindowsOptionsReport = this._onRequestWindowsOptionsReport.event, this._onA11yChar = this._register(new M()), this.onA11yChar = this._onA11yChar.event, this._onA11yTab = this._register(new M()), this.onA11yTab = this._onA11yTab.event, this._onCursorMove = this._register(new M()), this.onCursorMove = this._onCursorMove.event, this._onLineFeed = this._register(new M()), this.onLineFeed = this._onLineFeed.event, this._onScroll = this._register(new M()), this.onScroll = this._onScroll.event, this._onTitleChange = this._register(new M()), this.onTitleChange = this._onTitleChange.event, this._onColor = this._register(new M()), this.onColor = this._onColor.event, this._parseStack = {
			...
			257,
			258
		], this._register(this._parser), this._dirtyRowTracker = new ts(this._bufferService), this._activeBuffer = this._bufferService.buffer, this._register(this._bufferService.buffers.onBufferActivate((e) => this._activeBuffer = e.activeBuffer)), this._parser.setCsiHandlerFallback((e, t) => {
			...
			intermediates: "$",
			final: "p"
		}, (e) => this.requestMode(e, !1)), this._parser.setExecuteHandler(L.BEL, () => this.bell()), this._parser.setExecuteHandler(L.LF, () => this.lineFeed()), this._parser.setExecuteHandler(L.VT, () => this.lineFeed()), this._parser.setExecuteHandler(L.FF, () => this.lineFeed()), this._parser.setExecuteHandler(L.CR, () => this.carriageReturn()), this._parser.setExecuteHandler(L.BS, () => this.backspace()), this._parser.setExecuteHandler(L.HT, () => this.tab()), this._parser.setExecuteHandler(L.SO, () => this.shiftOut()), this._parser.setExecuteHandler(L.SI, () => this.shiftIn()), this._parser.setExecuteHandler(ri.IND, () => this.index()), this._parser.setExecuteHandler(ri.NEL, () => this.nextLine()), this._parser.setExecuteHandler(ri.HTS, () => this.tabSet()), this._parser.registerOscHandler(0, new Po((e) => (this.setTitle(e), this.setIconName(e), !0))), this._parser.registerOscHandler(1, new Po((e) => this.setIconName(e))), this._parser.registerOscHandler(2, new Po((e) => this.setTitle(e))), this._parser.registerOscHandler(4, new Po((e) => this.setOrReportIndexedColor(e))), this._parser.registerOscHandler(8, new Po((e) => this.setHyperlink(e))), this._parser.registerOscHandler(10, new Po((e) => this.setOrReportFgColor(e))), this._parser.registerOscHandler(11, new Po((e) => this.setOrReportBgColor(e))), this._parser.registerOscHandler(12, new Po((e) => this.setOrReportCursorColor(e))), this._parser.registerOscHandler(104, new Po((e) => this.restoreIndexedColor(e))), this._parser.registerOscHandler(110, new Po((e) => this.restoreFgColor(e))), this._parser.registerOscHandler(111, new Po((e) => this.restoreBgColor(e))), this._parser.registerOscHandler(112, new Po((e) => this.restoreCursorColor(e))), this._parser.registerEscHandler({ final: "7" }, () => this.saveCursor()), this._parser.registerEscHandler({ final: "8" }, () => this.restoreCursor()), this._parser.registerEscHandler({ final: "D" }, () => this.index()), this._parser.registerEscHandler({ final: "E" }, () => this.nextLine()), this._parser.registerEscHandler({ final: "H" }, () => this.tabSet()), this._parser.registerEscHandler({ final: "M" }, () => this.reverseIndex()), this._parser.registerEscHandler({ final: "=" }, () => this.keypadApplicationMode()), this._parser.registerEscHandler({ final: ">" }, () => this.keypadNumericMode()), this._parser.registerEscHandler({ final: "c" }, () => this.fullReset()), this._parser.registerEscHandler({ final: "n" }, () => this.setgLevel(2)), this._parser.registerEscHandler({ final: "o" }, () => this.setgLevel(3)), this._parser.registerEscHandler({ final: "|" }, () => this.setgLevel(3)), this._parser.registerEscHandler({ final: "}" }, () => this.setgLevel(2)), this._parser.registerEscHandler({ final: "~" }, () => this.setgLevel(1)), this._parser.registerEscHandler({
			intermediates: "%",
			final: "@"
		...
		this._parser.registerEscHandler({
			...
			intermediates: "$",
			final: "q"
		}, new Ro((e, t) => this.requestStatusString(e, t)));
	}
	getAttrData() {
	...
	_logSlowResolvingAsync(e) {
		this._logService.logLevel <= 3 && Promise.race([e, new Promise((e, t) => setTimeout(() => t("#SLOW_TIMEOUT"), Qo))]).catch((e) => {
			if (e !== "#SLOW_TIMEOUT") throw e;
			console.warn(`async parser handler taking longer than ${Qo} ms`);
		});
	}
	_getCurrentLinkId() {
	...
	print(e, t, n) {
		...
		for (let p = t; p < n; ++p) {
			...
			i = Eo.extractWidth(t);
			let n = Eo.extractShouldJoin(t), m = n ? Eo.extractWidth(f) : 0;
	...
	registerCsiHandler(e, t) {
		return e.final === "t" && !e.prefix && !e.intermediates ? this._parser.registerCsiHandler(e, (e) => Zo(e.params[0], this._optionsService.rawOptions.windowOptions) ? t(e) : !0) : this._parser.registerCsiHandler(e, t);
	}
	registerDcsHandler(e, t) {
		return this._parser.registerDcsHandler(e, new Ro(t));
	}
	registerEscHandler(e, t) {
		return this._parser.registerEscHandler(e, t);
	}
	registerOscHandler(e, t) {
		return this._parser.registerOscHandler(e, new Po(t));
	}
	bell() {
	...
	repeatPrecedingCharacter(e) {
		...
		if (!t) return !0;
		let n = e.params[0] || 1, r = Eo.extractWidth(t), i = this._activeBuffer.x - r, a = this._activeBuffer.lines.get(this._activeBuffer.ybase + this._activeBuffer.y).getString(i), o = new Uint32Array(a.length * n), s = 0;
	...
	sendDeviceAttributesPrimary(e) {
		return e.params[0] > 0 || (this._is("xterm") || this._is("rxvt-unicode") || this._is("screen") ? this._coreService.triggerDataEvent(L.ESC + "[?1;2c") : this._is("linux") && this._coreService.triggerDataEvent(L.ESC + "[?6c")), !0;
	}
	sendDeviceAttributesSecondary(e) {
		return e.params[0] > 0 || (this._is("xterm") ? this._coreService.triggerDataEvent(L.ESC + "[>0;276;0c") : this._is("rxvt-unicode") ? this._coreService.triggerDataEvent(L.ESC + "[>85;95;0c") : this._is("linux") ? this._coreService.triggerDataEvent(e.params[0] + "c") : this._is("screen") && this._coreService.triggerDataEvent(L.ESC + "[>83;40003;0c")), !0;
	}
	_is(e) {
	...
	setModePrivate(e) {
		for (let t = 0; t < e.length; t++) switch (e.params[t]) {
			case 1:
				...
				break;
			case 2:
				this._charsetService.setgCharset(0, to), this._charsetService.setgCharset(1, to), this._charsetService.setgCharset(2, to), this._charsetService.setgCharset(3, to);
				break;
			case 3:
	...
	requestMode(e, t) {
		...
		let r = this._coreService.decPrivateModes, { activeProtocol: i, activeEncoding: a } = this._coreMouseService, o = this._coreService, { buffers: s, cols: c } = this._bufferService, { active: l, alt: u } = s, d = this._optionsService.rawOptions, f = (e, n) => (o.triggerDataEvent(`${L.ESC}[${t ? "" : "?"}${e};${n}$y`), !0), p = (e) => e ? 1 : 2, m = e.params[0];
	...
	_updateAttrColor(e, t, n, r, i) {
		return t === 2 ? (e |= 50331648, e &= -16777216, e |= ce.fromColorRGB([
			n,
			r,
			i
	...
	deviceStatus(e) {
		switch (e.params[0]) {
			case 5:
				this._coreService.triggerDataEvent(`${L.ESC}[0n`);
				break;
			case 6:
				let e = this._activeBuffer.y + 1, t = this._activeBuffer.x + 1;
				this._coreService.triggerDataEvent(`${L.ESC}[${e};${t}R`);
				break;
		}
		return !0;
	}
	...
	windowOptions(e) {
		if (!Zo(e.params[0], this._optionsService.rawOptions.windowOptions)) return !0;
		...
		switch (e.params[0]) {
			...
			case 16:
				...
				break;
			case 18:
				this._bufferService && this._coreService.triggerDataEvent(`${L.ESC}[8;${this._bufferService.rows};${this._bufferService.cols}t`);
				break;
			case 22:
				(t === 0 || t === 2) && (this._windowTitleStack.push(this._windowTitle), this._windowTitleStack.length > Xo && this._windowTitleStack.shift()), (t === 0 || t === 1) && (this._iconNameStack.push(this._iconName), this._iconNameStack.length > Xo && this._iconNameStack.shift());
				break;
			case 23:
	...
	selectDefaultCharset() {
		return this._charsetService.setgLevel(0), this._charsetService.setgCharset(0, to), !0;
	}
	selectCharset(e) {
		return e.length === 2 ? (e[0] === "/" || this._charsetService.setgCharset(Jo[e[0]], X[e[1]] || to), !0) : (this.selectDefaultCharset(), !0);
	}
	index() {
	...
	requestStatusString(e, t) {
		let n = (e) => (this._coreService.triggerDataEvent(`${L.ESC}${e}${L.ESC}\\`), !0), r = this._bufferService.buffer, i = this._optionsService.rawOptions;
	...
	markRangeDirty(e, t) {
		e > t && ($o = e, e = t, t = $o), e < this.start && (this.start = e), t > this.end && (this.end = t);
	}
	markAllDirty() {
...
var rs = 5e7, is = 12, as = 50, os = class extends k {
	constructor(e) {
	...
	write(e, t) {
		if (this._pendingData > rs) throw Error("write data discarded, use flow control to avoid losing data");
		...
		for (; this._writeBuffer.length > this._bufferOffset;) {
			...
			if (r) {
				r.catch((e) => (queueMicrotask(() => {
					throw e;
				}), Promise.resolve(!1))).then((e) => performance.now() - n >= is ? setTimeout(() => this._innerWrite(0, e)) : this._innerWrite(n, e));
				return;
			}
			let i = this._callbacks[this._bufferOffset];
			if (i && i(), this._bufferOffset++, this._pendingData -= e.length, performance.now() - n >= is) break;
		}
		this._writeBuffer.length > this._bufferOffset ? (this._bufferOffset > as && (this._writeBuffer = this._writeBuffer.slice(this._bufferOffset), this._callbacks = this._callbacks.slice(this._bufferOffset), this._bufferOffset = 0), setTimeout(() => this._innerWrite())) : (this._writeBuffer.length = 0, this._callbacks.length = 0, this._pendingData = 0, this._bufferOffset = 0), this._onWriteParsed.fire();
	}
}, ss = class {
	constructor(e) {
...
ss = c([l(0, C)], ss);
var cs = !1, ls = class extends k {
	constructor(e) {
		super(), this._windowsWrappingHeuristics = this._register(new ot()), this._onBinary = this._register(new M()), this.onBinary = this._onBinary.event, this._onData = this._register(new M()), this.onData = this._onData.event, this._onLineFeed = this._register(new M()), this.onLineFeed = this._onLineFeed.event, this._onResize = this._register(new M()), this.onResize = this._onResize.event, this._onWriteParsed = this._register(new M()), this.onWriteParsed = this._onWriteParsed.event, this._onScroll = this._register(new M()), this._instantiationService = new za(), this.optionsService = this._register(new uo(e)), this._instantiationService.setService(T, this.optionsService), this._bufferService = this._register(this._instantiationService.createInstance(so)), this._instantiationService.setService(C, this._bufferService), this._logService = this._register(this._instantiationService.createInstance(Ha)), this._instantiationService.setService(w, this._logService), this.coreService = this._register(this._instantiationService.createInstance(go)), this._instantiationService.setService(me, this.coreService), this.coreMouseService = this._register(this._instantiationService.createInstance(xo)), this._instantiationService.setService(pe, this.coreMouseService), this.unicodeService = this._register(this._instantiationService.createInstance(Eo)), this._instantiationService.setService(ve, this.unicodeService), this._charsetService = this._instantiationService.createInstance(Do), this._instantiationService.setService(he, this._charsetService), this._oscLinkService = this._instantiationService.createInstance(ss), this._instantiationService.setService(_e, this._oscLinkService), this._inputHandler = this._register(new es(this._bufferService, this._charsetService, this.coreService, this._logService, this.optionsService, this._oscLinkService, this.coreMouseService, this.unicodeService)), this._register(j.forward(this._inputHandler.onLineFeed, this._onLineFeed)), this._register(this._inputHandler), this._register(j.forward(this._bufferService.onResize, this._onResize)), this._register(j.forward(this.coreService.onData, this._onData)), this._register(j.forward(this.coreService.onBinary, this._onBinary)), this._register(this.coreService.onRequestScrollToBottom(() => this.scrollToBottom(!0))), this._register(this.coreService.onUserInput(() => this._writeBuffer.handleUserInput())), this._register(this.optionsService.onMultipleOptionChange(["windowsMode", "windowsPty"], () => this._handleWindowsPtyOptionChange())), this._register(this._bufferService.onScroll(() => {
		...
		})), this._writeBuffer = this._register(new os((e, t) => this._inputHandler.parse(e, t))), this._register(j.forward(this._writeBuffer.onWriteParsed, this._onWriteParsed));
	}
	get onScroll() {
	...
	writeSync(e, t) {
		this._logService.logLevel <= 3 && !cs && (this._logService.warn("writeSync is unreliable and will be removed soon."), cs = !0), this._writeBuffer.writeSync(e, t);
	}
	input(e, t = !0) {
		this.coreService.triggerDataEvent(e, t);
	}
	resize(e, t) {
		isNaN(e) || isNaN(t) || (e = Math.max(e, ao), t = Math.max(t, oo), this._bufferService.resize(e, t));
	}
	scroll(e, t = !1) {
	...
	_enableWindowsWrappingHeuristics() {
		if (!this._windowsWrappingHeuristics.value) {
			let e = [];
			e.push(this.onLineFeed(Oo.bind(null, this._bufferService))), e.push(this.registerCsiHandler({ final: "H" }, () => (Oo(this._bufferService), !1))), this._windowsWrappingHeuristics.value = O(() => {
...
function ds(e, t, n, r) {
	...
	switch (e.keyCode) {
		case 0:
			e.key === "UIKeyInputUpArrow" ? t ? i.key = L.ESC + "OA" : i.key = L.ESC + "[A" : e.key === "UIKeyInputLeftArrow" ? t ? i.key = L.ESC + "OD" : i.key = L.ESC + "[D" : e.key === "UIKeyInputRightArrow" ? t ? i.key = L.ESC + "OC" : i.key = L.ESC + "[C" : e.key === "UIKeyInputDownArrow" && (t ? i.key = L.ESC + "OB" : i.key = L.ESC + "[B");
			break;
		case 8:
			i.key = e.ctrlKey ? "\b" : L.DEL, e.altKey && (i.key = L.ESC + i.key);
			break;
		case 9:
			if (e.shiftKey) {
				i.key = L.ESC + "[Z";
			...
			i.key = L.HT, i.cancel = !0;
			break;
		case 13:
			i.key = e.altKey ? L.ESC + L.CR : L.CR, i.cancel = !0;
			break;
		case 27:
			i.key = L.ESC, e.altKey && (i.key = L.ESC + L.ESC), i.cancel = !0;
			break;
		case 37:
			if (e.metaKey) break;
			a ? i.key = L.ESC + "[1;" + (a + 1) + "D" : t ? i.key = L.ESC + "OD" : i.key = L.ESC + "[D";
			break;
		case 39:
			if (e.metaKey) break;
			a ? i.key = L.ESC + "[1;" + (a + 1) + "C" : t ? i.key = L.ESC + "OC" : i.key = L.ESC + "[C";
			break;
		case 38:
			if (e.metaKey) break;
			a ? i.key = L.ESC + "[1;" + (a + 1) + "A" : t ? i.key = L.ESC + "OA" : i.key = L.ESC + "[A";
			break;
		case 40:
			if (e.metaKey) break;
			a ? i.key = L.ESC + "[1;" + (a + 1) + "B" : t ? i.key = L.ESC + "OB" : i.key = L.ESC + "[B";
			break;
		case 45:
			!e.shiftKey && !e.ctrlKey && (i.key = L.ESC + "[2~");
			break;
		case 46:
			a ? i.key = L.ESC + "[3;" + (a + 1) + "~" : i.key = L.ESC + "[3~";
			break;
		case 36:
			a ? i.key = L.ESC + "[1;" + (a + 1) + "H" : t ? i.key = L.ESC + "OH" : i.key = L.ESC + "[H";
			break;
		case 35:
			a ? i.key = L.ESC + "[1;" + (a + 1) + "F" : t ? i.key = L.ESC + "OF" : i.key = L.ESC + "[F";
			break;
		case 33:
			e.shiftKey ? i.type = 2 : e.ctrlKey ? i.key = L.ESC + "[5;" + (a + 1) + "~" : i.key = L.ESC + "[5~";
			break;
		case 34:
			e.shiftKey ? i.type = 3 : e.ctrlKey ? i.key = L.ESC + "[6;" + (a + 1) + "~" : i.key = L.ESC + "[6~";
			break;
		case 112:
			a ? i.key = L.ESC + "[1;" + (a + 1) + "P" : i.key = L.ESC + "OP";
			break;
		case 113:
			a ? i.key = L.ESC + "[1;" + (a + 1) + "Q" : i.key = L.ESC + "OQ";
			break;
		case 114:
			a ? i.key = L.ESC + "[1;" + (a + 1) + "R" : i.key = L.ESC + "OR";
			break;
		case 115:
			a ? i.key = L.ESC + "[1;" + (a + 1) + "S" : i.key = L.ESC + "OS";
			break;
		case 116:
			a ? i.key = L.ESC + "[15;" + (a + 1) + "~" : i.key = L.ESC + "[15~";
			break;
		case 117:
			a ? i.key = L.ESC + "[17;" + (a + 1) + "~" : i.key = L.ESC + "[17~";
			break;
		case 118:
			a ? i.key = L.ESC + "[18;" + (a + 1) + "~" : i.key = L.ESC + "[18~";
			break;
		case 119:
			a ? i.key = L.ESC + "[19;" + (a + 1) + "~" : i.key = L.ESC + "[19~";
			break;
		case 120:
			a ? i.key = L.ESC + "[20;" + (a + 1) + "~" : i.key = L.ESC + "[20~";
			break;
		case 121:
			a ? i.key = L.ESC + "[21;" + (a + 1) + "~" : i.key = L.ESC + "[21~";
			break;
		case 122:
			a ? i.key = L.ESC + "[23;" + (a + 1) + "~" : i.key = L.ESC + "[23~";
			break;
		case 123:
			a ? i.key = L.ESC + "[24;" + (a + 1) + "~" : i.key = L.ESC + "[24~";
			break;
		default:
			if (e.ctrlKey && !e.shiftKey && !e.altKey && !e.metaKey) e.keyCode >= 65 && e.keyCode <= 90 ? i.key = String.fromCharCode(e.keyCode - 64) : e.keyCode === 32 ? i.key = L.NUL : e.keyCode >= 51 && e.keyCode <= 55 ? i.key = String.fromCharCode(e.keyCode - 51 + 27) : e.keyCode === 56 ? i.key = L.DEL : e.keyCode === 219 ? i.key = L.ESC : e.keyCode === 220 ? i.key = L.FS : e.keyCode === 221 && (i.key = L.GS);
			else if ((!n || r) && e.altKey && !e.metaKey) {
				let t = us[e.keyCode]?.[+!!e.shiftKey];
				if (t) i.key = L.ESC + t;
				else if (e.keyCode >= 65 && e.keyCode <= 90) {
					let t = e.ctrlKey ? e.keyCode - 64 : e.keyCode + 32, n = String.fromCharCode(t);
					e.shiftKey && (n = n.toUpperCase()), i.key = L.ESC + n;
				} else if (e.keyCode === 32) i.key = L.ESC + (e.ctrlKey ? L.NUL : " ");
				else if (e.key === "Dead" && e.code.startsWith("Key")) {
					let t = e.code.slice(3, 4);
					e.shiftKey || (t = t.toLowerCase()), i.key = L.ESC + t, i.cancel = !0;
				}
			} else n && !e.altKey && !e.ctrlKey && !e.shiftKey && e.metaKey ? e.keyCode === 65 && (i.type = 1) : e.key && !e.ctrlKey && !e.altKey && !e.metaKey && e.keyCode >= 48 && e.key.length === 1 ? i.key = e.key : e.key && e.ctrlKey && (e.key === "_" && (i.key = L.US), e.key === "@" && (i.key = L.NUL));
			break;
	}
	return i;
}
var Q = 0, fs = class {
	constructor(e) {
		this._getKey = e, this._array = [], this._insertedValues = [], this._flushInsertedTask = new ia(), this._isFlushingInserted = !1, this._deletedIndices = [], this._flushDeletedTask = new ia(), this._isFlushingDeleted = !1;
	}
	clear() {
	...
	delete(e) {
		...
		if (t === void 0 || (Q = this._search(t), Q === -1) || this._getKey(this._array[Q]) !== t) return !1;
		do
			if (this._array[Q] === e) return this._deletedIndices.length === 0 && this._flushDeletedTask.enqueue(() => this._flushDeleted()), this._deletedIndices.push(Q), !0;
	...
	*getKeyIterator(e) {
		if (this._flushCleanupInserted(), this._flushCleanupDeleted(), this._array.length !== 0 && (Q = this._search(e), !(Q < 0 || Q >= this._array.length) && this._getKey(this._array[Q]) === e)) do
			yield this._array[Q];
...
}, ps = 0, ms = 0, hs = class extends k {
	constructor() {
		super(), this._decorations = new fs((e) => e?.marker.line), this._onDecorationRegistered = this._register(new M()), this.onDecorationRegistered = this._onDecorationRegistered.event, this._onDecorationRemoved = this._register(new M()), this.onDecorationRemoved = this._onDecorationRemoved.event, this._register(O(() => this.reset()));
	}
	get decorations() {
	...
	*getDecorationsAtCell(e, t, n) {
	...
	forEachDecorationAtCell(e, t, n, r) {
		this._decorations.forEachByKey(t, (t) => {
			ps = t.options.x ?? 0, ms = ps + (t.options.width ?? 1), e >= ps && e < ms && (!n || (t.options.layer ?? "bottom") === n) && r(t);
		});
	}
}, gs = class extends at {
	constructor(e) {
	...
	_handleChar(e) {
		this._liveRegionLineCount < ys + 1 && (this._charsToConsume.length > 0 ? this._charsToConsume.shift() !== e && (this._charsToAnnounce += e) : this._charsToAnnounce += e, e === "\n" && (this._liveRegionLineCount++, this._liveRegionLineCount === ys + 1 && (this._liveRegion.textContent += p.get())));
	}
	_clearLiveRegion() {
...
var Ss = class extends k {
	constructor(e, t, n, r, i) {
		super(), this._element = e, this._mouseService = t, this._renderService = n, this._bufferService = r, this._linkProviderService = i, this._linkCacheDisposables = [], this._isMouseOut = !0, this._wasResized = !1, this._activeLine = -1, this._onShowLinkUnderline = this._register(new M()), this.onShowLinkUnderline = this._onShowLinkUnderline.event, this._onHideLinkUnderline = this._register(new M()), this.onHideLinkUnderline = this._onHideLinkUnderline.event, this._register(O(() => {
			nt(this._linkCacheDisposables), this._linkCacheDisposables.length = 0, this._lastMouseEvent = void 0, this._activeProviderReplies?.clear();
		})), this._register(this._bufferService.onResize(() => {
			this._clearCurrentLink(), this._wasResized = !0;
		})), this._register(P(this._element, "mouseleave", () => {
			this._isMouseOut = !0, this._clearCurrentLink();
		})), this._register(P(this._element, "mousemove", this._handleMouseMove.bind(this))), this._register(P(this._element, "mousedown", this._handleMouseDown.bind(this))), this._register(P(this._element, "mouseup", this._handleMouseUp.bind(this)));
	}
	get currentLink() {
	...
	_handleMouseUp(e) {
		...
		let t = this._positionFromMouseEvent(e, this._element, this._mouseService);
		t && this._mouseDownLink && Cs(this._mouseDownLink.link, this._currentLink.link) && this._linkAtPosition(this._currentLink.link, t) && this._currentLink.link.activate(e, this._currentLink.link.text);
	}
	_clearCurrentLink(e, t) {
		!this._currentLink || !this._lastMouseEvent || (!e || !t || this._currentLink.link.range.start.y >= e && this._currentLink.link.range.end.y <= t) && (this._linkLeave(this._element, this._currentLink.link, this._lastMouseEvent), this._currentLink = void 0, nt(this._linkCacheDisposables), this._linkCacheDisposables.length = 0);
	}
	_handleNewLink(e) {
...
var ws = class extends ls {
	...
	_handleColorEvent(e) {
		if (this._themeService) for (let t of e) {
			...
			switch (t.type) {
				case 0:
					let r = U.toColorRGB(e === "ansi" ? this._themeService.colors.ansi[t.index] : this._themeService.colors[e]);
					this.coreService.triggerDataEvent(`${L.ESC}]${n};${qo(r)}${ii.ST}`);
					break;
				case 1:
					if (e === "ansi") this._themeService.modifyColors((e) => e.ansi[t.index] = H.toColor(...t.color));
					else {
						let n = e;
						this._themeService.modifyColors((e) => e[n] = H.toColor(...t.color));
					}
					break;
				case 2:
	...
	_handleScreenReaderModeOptionChange(e) {
		e ? !this._accessibilityManager.value && this._renderService && (this._accessibilityManager.value = this._instantiationService.createInstance(xs, this)) : this._accessibilityManager.clear();
	}
	_handleTextAreaFocus(e) {
		this.coreService.decPrivateModes.sendFocus && this.coreService.triggerDataEvent(L.ESC + "[I"), this.element.classList.add("focus"), this._showCursor(), this._onFocus.fire();
	}
	blur() {
		return this.textarea?.blur();
	}
	_handleTextAreaBlur() {
		this.textarea.value = "", this.refresh(this.buffer.y, this.buffer.y), this.coreService.decPrivateModes.sendFocus && this.coreService.triggerDataEvent(L.ESC + "[O"), this.element.classList.remove("focus"), this._onBlur.fire();
	}
	_syncTextArea() {
	...
	_initGlobal() {
		this._bindKeys(), this._register(P(this.element, "copy", (e) => {
			this.hasSelection() && g(e, this._selectionService);
		}));
		let e = (e) => _(e, this.textarea, this.coreService, this.optionsService);
		this._register(P(this.textarea, "paste", e)), this._register(P(this.element, "paste", e)), Gi ? this._register(P(this.element, "mousedown", (e) => {
			e.button === 2 && te(e, this.textarea, this.screenElement, this._selectionService, this.options.rightClickSelectsWord);
		})) : this._register(P(this.element, "contextmenu", (e) => {
			te(e, this.textarea, this.screenElement, this._selectionService, this.options.rightClickSelectsWord);
		})), $i && this._register(P(this.element, "auxclick", (e) => {
			e.button === 1 && ee(e, this.textarea, this.screenElement);
		}));
	}
	_bindKeys() {
		this._register(P(this.textarea, "keyup", (e) => this._keyUp(e), !0)), this._register(P(this.textarea, "keydown", (e) => this._keyDown(e), !0)), this._register(P(this.textarea, "keypress", (e) => this._keyPress(e), !0)), this._register(P(this.textarea, "compositionstart", () => this._compositionHelper.compositionstart())), this._register(P(this.textarea, "compositionupdate", (e) => this._compositionHelper.compositionupdate(e))), this._register(P(this.textarea, "compositionend", () => this._compositionHelper.compositionend())), this._register(P(this.textarea, "input", (e) => this._inputEvent(e), !0)), this._register(this.onRender(() => this._compositionHelper.updateCompositionElements()));
	}
	open(e) {
		...
		})), this._selectionService = this._register(this._instantiationService.createInstance(Oa, this.element, this.screenElement, r)), this._instantiationService.setService(Te, this._selectionService), this._register(this._selectionService.onRequestScrollLines((e) => this.scrollLines(e.amount, e.suppressScrollEvent))), this._register(this._selectionService.onSelectionChange(() => this._onSelectionChange.fire())), this._register(this._selectionService.onRequestRedraw((e) => this._renderService.handleSelectionChanged(e.start, e.end, e.columnSelectMode))), this._register(this._selectionService.onLinuxMouseSelection((e) => {
	...
	bindMouse() {
		...
		this._register(this.coreMouseService.onProtocolChange((e) => {
		...
		})), this.coreMouseService.activeProtocol = this.coreMouseService.activeProtocol, this._register(P(t, "mousedown", (e) => {
			...
			if (!r.wheel) {
				...
				if (!this.buffer.hasScrollback) {
					...
					let n = L.ESC + (this.coreService.decPrivateModes.applicationCursorKeys ? "O" : "[") + (t.deltaY < 0 ? "A" : "B");
	...
	paste(e) {
		v(e, this.textarea, this.coreService, this.optionsService);
	}
	...
	_keyDown(e) {
		...
		let n = ds(e, this.coreService.decPrivateModes.applicationCursorKeys, this.browser.isMac, this.options.macOptionIsMeta);
		...
		if ((n.key === L.ETX || n.key === L.CR) && (this.textarea.value = ""), this._onKey.fire({
			key: n.key,
			domEvent: e
	...
	_keyUp(e) {
		this._keyDownSeen = !1, !(this._customKeyEventHandler && this._customKeyEventHandler(e) === !1) && (Ts(e) || this.focus(), this.updateCursorStyle(e), this._keyPressHandled = !1);
	}
	_keyPress(e) {
		let t;
	...
	_reportFocus() {
		this.element?.classList.contains("focus") ? this.coreService.triggerDataEvent(L.ESC + "[I") : this.coreService.triggerDataEvent(L.ESC + "[O");
	}
...
var Es = class {
	...
	getCell(e, t) {
		if (!(e < 0 || e >= this._line.length)) return t ? (this._line.loadCell(e, t), t) : this._line.loadCell(e, new y());
	}
	...
	constructor(e) {
		super(), this._core = e, this._onBufferChange = this._register(new M()), this.onBufferChange = this._onBufferChange.event, this._normal = new Os(this._core.buffers.normal, "normal"), this._alternate = new Os(this._core.buffers.alt, "alternate"), this._core.buffers.onBufferActivate(() => this._onBufferChange.fire(this.active));
	}
	get active() {
...
}, Ms = ["cols", "rows"], Ns = 0, Ps = class extends k {
	constructor(e) {
		super(), this._core = this._register(new ws(e)), this._addonManager = this._register(new Es()), this._publicOptions = { ...this._core.options };
	...
	_checkReadonlyOptions(e) {
		if (Ms.includes(e)) throw Error(`Option "${e}" can only be set in the constructor`);
	}
	_checkProposedApi() {
	...
	get parser() {
		return this._parser ||= new As(this._core), this._parser;
	}
	get unicode() {
		return this._checkProposedApi(), new js(this._core);
	}
	get textarea() {
	...
	get buffer() {
		return this._buffer ||= this._register(new ks(this._core)), this._buffer;
	}
	get markers() {
	...
	_verifyIntegers(...e) {
		for (Ns of e) if (Ns === Infinity || isNaN(Ns) || Ns % 1 != 0) throw Error("This API only accepts integers");
	}
	_verifyPositiveIntegers(...e) {
		for (Ns of e) if (Ns && (Ns === Infinity || isNaN(Ns) || Ns % 1 != 0 || Ns < 0)) throw Error("This API only accepts positive integers");
	}
}, Fs = 2, Is = 1, Ls = class {
	activate(e) {
		this._terminal = e;
	...
	proposeDimensions() {
		...
		return {
			cols: Math.max(Fs, Math.floor(u / e.css.cell.width)),
			rows: Math.max(Is, Math.floor(l / e.css.cell.height))
		};
	}
}, Rs = class {
	state;
	constructor(e) {
		this.state = e || {
			...
			cwd: "/home/dayhoff"
		}, Object.keys(this.state.nodes).forEach((e) => {
			let t = this.state.nodes[e];
			if (t.parent && this.state.nodes[t.parent]) {
				let e = this.state.nodes[t.parent];
				e.children.includes(t.name) || e.children.push(t.name);
			}
		});
		let t = this.state.nodes["/"];
		t && (t.children = [
			"home",
			"bin",
			"etc",
	...
	createDirNode(e, t, n = "rwxr-xr-x") {
		return {
			name: e,
			type: "directory",
			parent: t,
			permissions: n,
			owner: e === "root" ? "root" : "dayhoff",
			group: e === "root" ? "root" : "dayhoff",
			createdAt: Date.now(),
			modifiedAt: Date.now(),
			children: []
		};
	...
	findNodes(e, t) {
		let n = this.resolvePath(e), r = [], i = Object.keys(this.state.nodes);
		for (let e of i) e.startsWith(n) && (!t || e.includes(t)) && r.push(e);
		return r;
	}
	getState() {
	...
	resolvePath(e) {
		if (e === "~") return "/home/dayhoff";
		if (e.startsWith("~/")) return this.normalizePath("/home/dayhoff/" + e.substring(2));
		if (e.startsWith("/")) return this.normalizePath(e);
		let t = this.state.cwd === "/" ? `/${e}` : `${this.state.cwd}/${e}`;
		return this.normalizePath(t);
	}
	normalizePath(e) {
		let t = e.split("/").filter(Boolean), n = [];
		for (let e of t) e !== "." && (e === ".." ? n.pop() : n.push(e));
		let r = "/" + n.join("/");
		return r === "" ? "/" : r;
	}
	getNode(e) {
		let t = this.resolvePath(e);
		return this.state.nodes[t] || null;
	}
	checkPermission(e, t, n) {
		if (t === "root") return !0;
	...
	setCwd(e, t = "dayhoff") {
		let n = this.resolvePath(e), r = this.getNode(n);
		return r && r.type === "directory" && this.checkPermission(n, t, "x") ? (this.state.cwd = n, !0) : !1;
	}
	listDirectory(e, t = "dayhoff") {
		let n = e ? this.resolvePath(e) : this.state.cwd, r = this.getNode(n);
		return r && r.type === "directory" && this.checkPermission(n, t, "r") ? r.children : null;
	}
	readFile(e, t = "dayhoff") {
		let n = this.resolvePath(e), r = this.getNode(n);
		return r && r.type === "file" ? this.checkPermission(n, t, "r") ? r.content : "Permissão negada" : null;
	}
	writeFile(e, t, n = "dayhoff", r = !1) {
		let i = this.resolvePath(e), a = this.getNode(i);
		if (a) {
			if (a.type === "directory" || !this.checkPermission(i, n, "w")) return !1;
			let e = a;
			return e.content = r ? e.content + t : t, e.modifiedAt = Date.now(), !0;
		} else {
			let e = i.split("/"), r = e.pop(), a = "/" + e.filter(Boolean).join("/"), o = this.getNode(a);
			if (o && o.type === "directory") {
				if (!this.checkPermission(a, n, "w")) return !1;
				let e = {
					name: r,
					type: "file",
					parent: a,
				...
				return this.state.nodes[i] = e, o.children.push(r), !0;
			}
		}
		return !1;
	}
	mkdir(e, t = "dayhoff") {
		...
		if (this.getNode(n)) return !1;
		let r = n.split("/"), i = r.pop(), a = "/" + r.filter(Boolean).join("/"), o = this.getNode(a);
		if (o && o.type === "directory") {
			if (!this.checkPermission(a, t, "w")) return !1;
			let e = this.createDirNode(i, a);
			return e.owner = t, e.group = t, this.state.nodes[n] = e, o.children.push(i), !0;
		}
		return !1;
	}
	rm(e, t = "dayhoff", n = !1) {
		let r = this.resolvePath(e);
		if (r === "/") return !1;
		let i = this.getNode(r);
		if (!i) return !1;
		let a = i.parent || "/";
		if (!this.checkPermission(a, t, "w") || i.type === "directory" && !n) return !1;
		if (i.type === "directory" && n) {
			let e = [...i.children];
			for (let n of e) this.rm(`${r}/${n}`, t, !0);
		}
		let o = this.getNode(a);
		return o && o.type === "directory" && (o.children = o.children.filter((e) => e !== i.name)), delete this.state.nodes[r], !0;
	}
	chmod(e, t, n = "dayhoff") {
		let r = this.resolvePath(e), i = this.state.nodes[r];
		return i ? n !== "root" && i.owner !== n ? !1 : (i.permissions = t, i.modifiedAt = Date.now(), !0) : !1;
	}
	chown(e, t, n = "dayhoff") {
		let r = this.resolvePath(e), i = this.state.nodes[r];
		return i && n === "root" ? (i.owner = t, i.modifiedAt = Date.now(), !0) : !1;
	}
}, zs = [
	{
		name: "pwd",
	...
	},
	{
		...
		execute: async (e) => {
			let t = e.args.some((e) => (e.includes("a") || e === "--all") && e.startsWith("-")), n = e.args.some((e) => e.includes("l") && e.startsWith("-")), r = e.args.find((e) => !e.startsWith("-")) || e.vfs.getCwd(), i = e.vfs.listDirectory(r, e.user);
			if (i) {
				let a = t ? [
					".",
					"..",
					...i
				] : i.filter((e) => !e.startsWith("."));
				if (n) {
					e.print("total " + a.length * 4);
					for (let t of a) {
						let n;
						if (n = t === "." ? e.vfs.getNode(r) : t === ".." ? e.vfs.getNode(e.vfs.resolvePath(r + "/..")) : e.vfs.getNode(e.vfs.resolvePath(r + "/" + t)), n) {
							let r = n.type === "directory" ? "d" : "-", i = new Date(n.modifiedAt).toLocaleDateString("pt-BR", {
								month: "short",
								day: "2-digit",
								hour: "2-digit",
								minute: "2-digit"
							}), a = n.type === "directory" ? "\x1B[1;34m" : "", o = a ? "\x1B[0m" : "";
							e.print(`${r}${n.permissions} 1 ${n.owner} ${n.group} 4096 ${i} ${a}${t}${o}`);
						}
					}
				} else {
					let t = a.map((t) => {
						let n;
						return n = t === "." ? e.vfs.getNode(r) : t === ".." ? e.vfs.getNode(e.vfs.resolvePath(r + "/..")) : e.vfs.getNode(e.vfs.resolvePath(r + "/" + t)), n && n.type === "directory" ? `\x1b[1;34m${t}\x1b[0m` : t;
					});
					e.print(t.join("  "));
				}
			} else e.printError(`ls: não foi possível acessar '${r}': Permissão negada ou Diretório não encontrado`);
		}
	},
	{
		name: "cd",
		...
		execute: async (e) => {
			let t = e.args[0] || "/home/dayhoff";
			e.vfs.setCwd(t, e.user) || e.printError(`cd: ${t}: Permissão negada ou Arquivo ou diretório não encontrado`);
		}
	},
	{
		name: "cat",
		...
		execute: async (e) => {
			if (e.args.length === 0) {
				e.printError("cat: operando de arquivo ausente");
				return;
			}
			for (let t of e.args) {
				let n = e.vfs.readFile(t, e.user);
				n !== null && n !== "Permissão negada" ? e.print(n) : e.printError(`cat: ${t}: Permissão negada ou Arquivo ou diretório não encontrado`);
			}
		}
	},
	{
		...
		execute: async (e) => {
			let t = e.args.includes("-p") || e.args.includes("--parents"), n = e.args.includes("-v") || e.args.includes("--verbose"), r = e.args.filter((e) => !e.startsWith("-"));
			if (r.length === 0) {
				e.printError("mkdir: operando ausente");
				return;
			}
			for (let i of r) if (t) {
				let t = e.vfs.resolvePath(i).split("/").filter(Boolean), r = "";
				for (let i of t) r += "/" + i, e.vfs.getNode(r) || (e.vfs.mkdir(r, e.user), n && e.print(`mkdir: diretório criado '${r}'`));
			} else e.vfs.mkdir(i, e.user) ? n && e.print(`mkdir: diretório criado '${i}'`) : e.printError(`mkdir: não foi possível criar o diretório '${i}': Permissão negada ou arquivo já existe`);
		}
	},
	{
		name: "rm",
		...
		execute: async (e) => {
			let t = !1, n = !1, r = !1, i = [];
			for (let a of e.args) a.startsWith("-") ? ((a.includes("r") || a.includes("R")) && (t = !0), a.includes("f") && (n = !0), a.includes("v") && (r = !0)) : i.push(a);
			if (i.length === 0) {
				n || e.printError("rm: operando ausente");
				return;
			}
			for (let a of i) {
				let i = e.vfs.getNode(a);
				if (!i) {
					n || e.printError(`rm: não foi possível remover '${a}': Arquivo ou diretório inexistente`);
					continue;
				}
				if (i.type === "directory" && !t) {
					e.printError(`rm: não foi possível remover '${a}': É um diretório`);
					continue;
				}
				e.vfs.rm(a, e.user, t) ? r && e.print(`removido '${a}'`) : n || e.printError(`rm: não foi possível remover '${a}': Permissão negada`);
			}
		}
	},
	{
		...
		execute: async (e) => {
			let t = e.args.indexOf(">"), n = e.args.indexOf(">>");
			if (t !== -1 || n !== -1) {
				let r = n !== -1, i = r ? n : t, a = e.args.slice(0, i).join(" "), o = e.args[i + 1];
				if (!o) {
					e.printError("zsh: erro de sintaxe próximo ao token inesperado `newline'");
					return;
				}
				e.vfs.writeFile(o, a, e.user, r) || e.printError(`zsh: ${o}: Permissão negada ou Diretório não encontrado`);
			} else e.print(e.args.join(" "));
		}
	},
	{
		name: "clear",
	...
	},
	{
		...
		execute: async (e) => {
			e.print((/* @__PURE__ */ new Date()).toLocaleString("pt-BR"));
		}
	},
	{
		name: "cp",
		...
		execute: async (e) => {
			if (e.args.length < 2) {
				e.printError("cp: operando de arquivo ausente");
				return;
			}
			let t = e.args[0], n = e.args[1], r = e.vfs.readFile(t, e.user);
			r !== null && r !== "Permissão negada" ? e.vfs.writeFile(n, r, e.user) || e.printError(`cp: não foi possível criar o arquivo '${n}': Permissão negada`) : e.printError(`cp: não foi possível obter estado de '${t}': Permissão negada ou Arquivo não encontrado`);
		}
	},
	{
		name: "touch",
		...
		execute: async (e) => {
			if (e.args.length === 0) {
				e.printError("touch: operando de arquivo ausente");
				return;
			}
			for (let t of e.args) {
				let n = e.vfs.readFile(t, e.user);
				n === null ? e.vfs.writeFile(t, "", e.user) : n === "Permissão negada" ? e.printError(`touch: ${t}: Permissão negada`) : e.vfs.writeFile(t, n, e.user);
			}
		}
	},
	{
		...
		execute: async (e) => {
			if (e.args.length < 2) {
				e.printError("mv: operando de arquivo ausente");
				return;
			}
			let t = e.args[0], n = e.args[1], r = e.vfs.readFile(t, e.user);
			r !== null && r !== "Permissão negada" ? e.vfs.writeFile(n, r, e.user) ? e.vfs.rm(t, e.user) : e.printError(`mv: não foi possível mover '${t}' para '${n}': Permissão negada`) : e.printError(`mv: não foi possível obter estado de '${t}': Permissão negada ou Arquivo não encontrado`);
		}
	}
], Bs = [
	{
		...
		execute: async (e) => {
			let t = e.args[0];
			if (!t) {
				e.print("Qual página de manual você deseja?");
				return;
			}
			e.print({
			...
			}[t] || `Nenhuma entrada de manual para ${t}`);
		}
	},
	{
		name: "sudo",
		...
		execute: async (e) => {
			e.args.length === 0 && e.print("Uso: sudo [comando]");
		}
	},
	{
		name: "history",
	...
	},
	{
		...
		execute: async (e) => {
			e.print(" 14:30:05 up 2 days,  4:12,  1 user,  load average: 0.05, 0.02, 0.01");
		}
	},
	{
		name: "ssh",
		...
		execute: async (e) => {
			if (!e.args[0]) {
				e.print("Uso: ssh usuario@host");
				return;
			}
			e.print(`Conectando-se a ${e.args[0]}...\nSSH connection established.`);
		}
	},
	{
		name: "groups",
		...
		execute: async (e) => {
			e.print(e.user === "root" ? "root" : "dayhoff sudo bioinfo labiomics");
		}
	},
	{
		name: "id",
		...
		execute: async (e) => {
			e.print(e.user === "root" ? "uid=0(root) gid=0(root) grupos=0(root)" : "uid=1000(dayhoff) gid=1000(dayhoff) grupos=1000(dayhoff),27(sudo),1001(labiomics)");
		}
	},
	{
		name: "du",
		...
		execute: async (e) => {
			let t = e.args.includes("-h");
			e.print(`${t ? "452M" : "462848"}\t${e.args.find((e) => !e.startsWith("-")) || "."}`);
		}
	},
	{
		name: "vim",
	...
	},
	{
		...
		execute: async (e) => {
			if (!e.args[0]) {
				e.printError("sbatch: erro: nenhum script especificado");
				return;
			}
			e.print(`Submitted batch job ${Math.floor(Math.random() * 9e5) + 1e5}`);
		}
	},
	{
		name: "squeue",
		...
		execute: async (e) => {
			e.print("             JOBID PARTITION     NAME     USER ST       TIME  NODES\n123456     batch   align     dayhoff  R       5:12      1");
		}
	},
	{
		name: "sinfo",
		...
		execute: async (e) => {
			e.print("PARTITION AVAIL  TIMELIMIT  NODES  STATE NODELIST\nbatch*       up   infinite      8   idle node-[01-08]");
		}
	},
	{
		name: "scancel",
		...
		execute: async (e) => {
			e.args[0] && e.print(`Job ${e.args[0]} cancelled.`);
		}
	},
	{
		name: "top",
	...
	},
	{
		...
		execute: async (e) => {
			e.print("NAME   MAJ:MIN RM   SIZE RO TYPE MOUNTPOINTS\nsda      8:0    0    50G  0 disk \n└─sda1   8:1    0    50G  0 part /");
		}
	}
], Vs = [
	{
		...
		execute: async (e) => {
			let t = e.args[0];
			if (!t) {
				e.printError("Uso: bio-count [sequência ou arquivo]");
				return;
			}
			let n = (e.vfs.readFile(t) || t).toUpperCase(), r = {
				A: 0,
				T: 0,
				C: 0,
				G: 0,
			...
			for (let e of n) r[e] === void 0 ? /[A-Z]/.test(e) && r.N++ : r[e]++;
			e.print("\x1B[1;32mRelatório de Sequência:\x1B[0m"), e.print(`  A: ${r.A}\n  T: ${r.T}\n  C: ${r.C}\n  G: ${r.G}`), r.N > 0 && e.print(`  Outros/N: ${r.N}`);
			let i = r.A + r.T + r.C + r.G + r.N, a = i > 0 ? ((r.G + r.C) / (r.A + r.T + r.C + r.G) * 100).toFixed(2) : "0.00";
			e.print(`  Total: ${i} bp\n  Conteúdo GC: ${a}%`);
		}
	},
	{
		...
		execute: async (e) => {
			let t = e.args[0];
			if (!t) {
				e.printError("Uso: bio-rev-comp [sequência ou arquivo]");
				return;
			}
			let n = (e.vfs.readFile(t) || t).toUpperCase(), r = {
				A: "T",
				...
				G: "C",
				N: "N"
			}, i = n.split("").reverse().map((e) => r[e] || e).join("");
			e.print(i);
		}
	},
	{
		...
		execute: async (e) => {
			let t = e.args[0];
			if (!t) {
				e.printError("Uso: fasta-view [arquivo]");
				return;
			}
			let n = e.vfs.readFile(t);
			if (n === null) {
				e.printError(`fasta-view: ${t}: Arquivo não encontrado`);
				return;
			}
			n.split("\n").forEach((t) => {
				t.startsWith(">") ? e.print(`\x1b[1;34m${t}\x1b[0m`) : e.print(t.replace(/A/g, "\x1B[1;32mA\x1B[0m").replace(/T/g, "\x1B[1;31mT\x1B[0m").replace(/C/g, "\x1B[1;33mC\x1B[0m").replace(/G/g, "\x1B[1;36mG\x1B[0m"));
			});
		}
	},
	{
		...
		execute: async (e) => {
			if (!e.args[0]) {
				e.printError("Uso: fastqc seqfile1 seqfile2 .. seqfileN");
				return;
			}
			e.print(`Started analysis of ${e.args[0]}`), await new Promise((e) => setTimeout(e, 800)), e.print(`Analysis complete for ${e.args[0]}\nHTML report saved to ${e.args[0].split(".")[0]}_fastqc.html\nZIP archive saved to ${e.args[0].split(".")[0]}_fastqc.zip`);
		}
	},
	{
		name: "multiqc",
		...
		execute: async (e) => {
			e.print("[INFO   ]         multiqc : This is MultiQC v1.14"), e.print(`[INFO   ]         multiqc : Searching '${e.args[0] || "."}'`), await new Promise((e) => setTimeout(e, 600)), e.print("[INFO   ]         multiqc : MultiQC complete");
		}
	},
	{
		name: "trimmomatic",
		...
		execute: async (e) => {
			e.print(`TrimmomaticPE: Started with arguments: ${e.args.join(" ")}`), await new Promise((e) => setTimeout(e, 700)), e.print("Input Read Pairs: 100000 Both Surviving: 95000 (95.00%) Dropped: 1500 (1.50%)");
		}
	},
	{
		name: "fastp",
	...
	},
	{
		...
		execute: async (e) => {
			let t = e.args[0];
			t === "index" ? e.print("[bwa_index] Pack FASTA... 0.05 sec\n[bwa_index] Construct BWT... done") : t === "mem" ? e.print("[M::bwa_idx_load] loaded index\n[M::mem_process_seqs] Processed 100000 reads") : e.print("Usage: bwa <command> [options]");
		}
	},
	{
		name: "bowtie2",
		...
		execute: async (e) => {
			e.print("95.00% overall alignment rate");
		}
	},
	{
		name: "minimap2",
	...
	},
	{
		...
		execute: async (e) => {
			e.print("Apr 23 14:00:46 ..... finished successfully");
		}
	},
	{
		name: "samtools",
		...
		execute: async (e) => {
			let t = e.args[0];
			t === "view" ? e.print("r001	163	chr1	7	30	8M2I4M	*") : t === "flagstat" ? e.print("100000 + 0 in total\n95000 + 0 mapped (95.00%)") : e.print("Usage: samtools <command> [options]");
		}
	},
	{
		name: "picard",
		...
		execute: async (e) => {
			e.print(`INFO    PicardCommandLine       Invoking ${e.args[0] || "Help"}\nINFO    Successfully completed!`);
		}
	},
	{
		name: "gatk",
		...
		execute: async (e) => {
			e.print("14:15:30.000 INFO  GATK - Shutting down engine\nElapsed time: 0.50 minutes.");
		}
	},
	{
		name: "bcftools",
		...
		execute: async (e) => {
			e.print("Program: bcftools (Tools for variant calling and manipulating VCFs)");
		}
	},
	{
		name: "freebayes",
	...
	},
	{
		...
		execute: async (e) => {
			e.print("After filtering, kept 12500 out of a possible 15000 Sites");
		}
	},
	{
		name: "snpeff",
		...
		execute: async (e) => {
			e.print("Done. Predicted effects for 12500 variants.");
		}
	},
	{
		name: "spades",
	...
	},
	{
		...
		execute: async (e) => {
			e.print("1500 contigs, N50 18000 bp\n--- ALL DONE ---");
		}
	},
	{
		name: "quast",
	...
	},
	{
		...
		execute: async (e) => {
			e.print("C:98.4%[S:98.4%,D:0.0%],F:0.8%,M:0.8%,n:124");
		}
	},
	{
		name: "iqtree",
		...
		execute: async (e) => {
			e.print("IQ-TREE 2.2.0.3 built May 2026\nReading alignment file alignment.phy... 100 taxa with 1500 sites\nBest-fit model: GTR+F+I+G4 chosen via BIC"), await new Promise((e) => setTimeout(e, 600)), e.print("Total log-likelihood: -12450.56\nOptimal tree written to alignment.phy.treefile");
		}
	},
	{
		name: "mafft",
	...
	},
	{
		...
		execute: async (e) => {
			e.print("1000000 reads processed\n850000 reads pseudoaligned");
		}
	},
	{
		name: "featurecounts",
		...
		execute: async (e) => {
			e.print("Successfully assigned alignments : 820000 (82.0%)");
		}
	},
	{
		name: "kraken2",
		...
		execute: async (e) => {
			e.print("850000 sequences classified (85.00%)\n150000 sequences unclassified (15.00%)");
		}
	},
	{
		name: "bracken",
		...
		execute: async (e) => {
			e.print("Bracken complete. Results in bracken_out.txt");
		}
	},
	{
		name: "metabat2",
	...
	},
	{
		...
		execute: async (e) => {
			e.print("[CheckM v1.1.3] CheckM lineage_wf\nBin Id     Marker lineage     Completeness  Contamination"), e.print("bin.1      o__Enterobacteriales   98.5%         1.2%"), e.print("bin.2      o__Bacteroidales       92.1%         0.5%");
		}
	},
	{
		name: "plink",
	...
	},
	{
		...
		execute: async (e) => {
			e.print("file       format  type  num_seqs  sum_len\nreads.fq   FASTQ   DNA   100,000   15.0M");
		}
	},
	{
		name: "bedtools",
		...
		execute: async (e) => {
			e.print("chr1	100	200	geneA	chr1	150	250	exon1");
		}
	},
	{
		name: "multiqc",
		...
		help: "multiqc .",
		execute: async (e) => {
			e.print("[INFO   ] multiqc : Search complete. Report: multiqc_report.html");
		}
	}
], Hs = [
	{
		...
		execute: async (e) => {
			let t = e.args[0];
			if (!t) {
				e.printError("wget: URL ausente");
				return;
			}
			e.print(`--${(/* @__PURE__ */ new Date()).toISOString()}--  ${t}\nConectando... OK\nRequisição HTTP enviada, aguardando resposta... 200 OK\nSalvando em: '${t.split("/").pop() || "index.html"}'`);
		}
	},
	{
		name: "curl",
		...
		execute: async (e) => {
			let t = e.args.find((e) => !e.startsWith("-"));
			if (!t) {
				e.printError("curl: use --help para mais informações");
				return;
			}
			e.args.includes("-v") && e.print(`*   Trying 127.0.0.1:80...\n* Connected to ${t} port 80`), e.print(`<html><body>Simulando resposta de ${t}</body></html>`);
		}
	},
	{
		name: "tar",
	...
	},
	{
		...
		execute: async (e) => {
			e.print("Simulando transformação de fluxo...");
		}
	},
	{
		name: "awk",
		...
		execute: async (e) => {
			e.print("Simulando processamento de colunas...");
		}
	},
	{
		name: "sort",
	...
	},
	{
		...
		execute: async (e) => {
			e.print("Linux LaBiOmicS 5.15.0-generic #1 SMP x86_64 GNU/Linux");
		}
	},
	{
		name: "hostname",
	...
	},
	{
		...
		execute: async (e) => {
			e.args[0] && e.print(`Processo ${e.args[0]} encerrado.`);
		}
	},
	{
		name: "export",
	...
	},
	{
		...
		execute: async (e) => {
			let t = parseInt(e.args[0] || "1");
			await new Promise((e) => setTimeout(e, Math.min(t * 1e3, 3e3)));
		}
	},
	{
		name: "which",
	...
	},
	{
		...
		execute: async (e) => {
			e.print("Simulando execução em lote...");
		}
	}
], Us = () => JSON.parse(localStorage.getItem("terminal_envs") || "[\"base\"]"), Ws = (e) => {
	let t = Us();
	t.includes(e) || (t.push(e), localStorage.setItem("terminal_envs", JSON.stringify(t)));
}, Gs = (e) => JSON.parse(localStorage.getItem(`pkgs_${e}`) || "[\"python\", \"pip\", \"bash\"]"), Ks = (e, t) => {
	let n = Gs(e);
	n.includes(t) || (n.push(t), localStorage.setItem(`pkgs_${e}`, JSON.stringify(n)));
}, qs = [
	{
		name: "conda",
		...
		execute: async (e) => {
			let t = e.args[0], n = localStorage.getItem("current_env") || "base", r = e.args.indexOf("-c"), i = r === -1 ? "defaults" : e.args[r + 1];
			if (t === "install") {
				let t = e.args.find((e) => !e.startsWith("-") && e !== "install");
				if (!t) {
					e.printError("conda install: erro: especifique o pacote");
					return;
				}
				e.print(`Solving environment: done\n## Package Plan ##\n  added: ${t}\nProceed ([y]/n)? y\nExecuting transaction: done`), Ks(n, t);
			} else if (t === "search") {
				let t = e.args[1] || "python";
				e.print(`Loading channels: done\n# Name                       Version           Build  Channel\n${t.padEnd(26)} 3.10.4      h1234567_0  ${i}`);
			} else if (t === "info") e.print(`     active environment : ${n}\n    active env location : /home/dayhoff/conda/envs/${n}\n            shell level : 1\n       conda version : 23.1.0`);
			else if (t === "list") e.print(`# packages in environment at /home/dayhoff/conda/envs/${n}:`), Gs(n).forEach((t) => e.print(`${t.padEnd(25)} 1.2.3                py310_0`));
			else if (t === "activate") {
				let t = e.args[1] || "base";
				Us().includes(t) ? (e.setEnv(t), e.print(`Ambiente '${t}' ativado.`)) : e.printError(`conda activate: ambiente não encontrado: ${t}`);
			} else t === "env" && e.args[1] === "list" ? (e.print("# conda environments:\n#"), Us().forEach((t) => e.print(`${t.padEnd(20)} ${t === n ? "*" : " "} /home/dayhoff/conda/envs/${t}`))) : e.print("Uso: conda [install|remove|activate|list|search|info|env list]");
		}
	},
	{
		name: "mamba",
		...
		execute: async (e) => {
			let t = e.args[0], n = localStorage.getItem("current_env") || "base";
			if (t === "install") {
				let t = e.args.find((e) => !e.startsWith("-") && e !== "install") || "fastqc";
				e.print(`\x1b[1;36mbioconda/linux-64\x1b[0m                   \x1b[1;32m[OK]\x1b[0m\n\x1b[1;32mConfirm? [Y/n]\x1b[0m y\n\x1b[32m${t}\x1b[0m [####################] 100%`), Ks(n, t);
			} else if (t === "create") {
				let t = e.args.indexOf("-n"), n = t === -1 ? null : e.args[t + 1];
				n && (e.print(`Creating environment ${n}... done`), Ws(n));
			} else t === "repoquery" ? e.print(`Searching for ${e.args[2] || "samtools"}...\nsamtools 1.16.1 (bioconda)\nbwa 0.7.17 (bioconda)`) : e.print("Uso: mamba [install|create|activate|repoquery|list]");
		}
	},
	{
		name: "micromamba",
		...
		execute: async (e) => {
			if (e.args[0] === "shell" && e.args[1] === "init") e.print("Enabling micromamba shell support in ~/.bashrc...\nSuccessfully initialized.");
			else {
				let t = qs.find((e) => e.name === "mamba");
				t && await t.execute(e);
			}
		}
	},
	{
		...
		execute: async (e) => {
			...
			if (t === "install") {
				let t = e.args.find((e) => !e.startsWith("-") && e !== "install");
				if (!t) {
					e.printError("pip install: especifique o pacote");
					return;
				}
				e.print(`Collecting ${t}\n  Downloading ${t}-2.4.1.whl\nSuccessfully installed ${t}`);
			} else t === "show" ? e.print(`Name: ${e.args[1] || "pandas"}\nVersion: 1.5.3\nSummary: Powerful data structures for data analysis\nLocation: /usr/local/lib/python3.10/dist-packages`) : t === "freeze" ? e.print("numpy==1.24.2\npandas==1.5.3\nscipy==1.10.1\nmatplotlib==3.7.1") : t === "list" ? e.print("Package    Version\n---------- -------\npip        23.0.1\nsetuptools 67.8.0") : e.print("Usage: pip [install|uninstall|list|show|freeze|search]");
		}
	},
	{
		name: "pyenv",
		...
		execute: async (e) => {
			let t = e.args[0];
			if (t === "versions") e.print("  system\n* 3.10.4 (set by /home/dayhoff/.pyenv/version)\n  3.11.0\n  3.12-dev");
			else if (t === "install") {
				let t = e.args[1] || "3.11.0";
				e.print(`Downloading Python-${t}.tar.xz...\nInstalling Python-${t}... [OK]`);
			} else t === "global" ? e.print(`Global Python version set to ${e.args[1] || "3.10.4"}`) : e.print("Usage: pyenv [install|versions|global|local|which]");
		}
	},
	{
		name: "apt",
		...
		execute: async (e) => {
			let t = e.args[0], n = e.args[1];
			if (t === "update") e.print("Atingido:1 http://br.archive.ubuntu.com/ubuntu jammy InRelease"), e.print("Obter:2 http://br.archive.ubuntu.com/ubuntu jammy-updates InRelease [119 kB]"), e.print("Obter:3 http://br.archive.ubuntu.com/ubuntu jammy-backports InRelease [108 kB]"), e.print("Obter:4 http://security.ubuntu.com/ubuntu jammy-security InRelease [110 kB]"), e.print("Lendo listas de pacotes... 0%"), await new Promise((e) => setTimeout(e, 400)), e.print("Lendo listas de pacotes... 100% [Pronto]");
			else if (t === "install") {
				if (!n) {
					e.printError("apt install: erro: pacote não especificado");
					return;
				}
				e.print("Lendo listas de pacotes... Pronto\nConstruindo árvore de dependências... Pronto"), e.print(`Os seguintes pacotes ADICIONAIS serão instalados:\n  lib${n}-dev common-${n}`), e.print(`Os seguintes NOVOS pacotes serão instalados:\n  ${n} lib${n}-dev common-${n}`), e.print("0 atualizados, 3 novos instalados, 0 a serem removidos."), e.print("É preciso baixar 1.250 kB de arquivos."), e.print("Depois desta operação, 4.500 kB de espaço em disco rígido serão utilizados."), e.print("Obter:1 http://br.archive.ubuntu.com/ubuntu jammy/main ... [OK]"), e.print(`Configurando ${n} (1.2.3-1ubuntu1) ...`), e.print("\x1B[32mProgresso: [########################################] 100%\x1B[0m"), Ks("system", n);
			} else t === "search" ? e.print(`Sorting... Done\nFull Text Search... Done\n${n || "samtools"}/jammy 1.16.1-1 amd64\n  Tools for manipulating next-generation sequencing data`) : e.print("Uso: apt [install|remove|update|search|list]");
		}
	},
	{
		name: "make",
		...
		execute: async (e) => {
			if (e.vfs.readFile("Makefile", e.user)) {
				let t = e.args[0] || "all";
				e.print("gcc -Wall -O2 -c main.c -o main.o"), e.print("gcc -Wall -O2 -c utils.c -o utils.o"), e.print("gcc main.o utils.o -o program"), e.print(`\x1b[1;32mMake: Alvo '${t}' concluído com sucesso.\x1b[0m`);
			} else e.printError("make: *** Nenhum alvo especificado e nenhum makefile encontrado. Pare.");
		}
	},
	{
		name: "snakemake",
	...
	},
	{
		...
		execute: async (e) => {
			let t = e.args[0];
			t === "ps" ? (e.print("CONTAINER ID   IMAGE          STATUS         NAMES"), JSON.parse(localStorage.getItem("docker_containers") || "[]").forEach((t) => e.print(`${t.id.padEnd(14)} ${t.image.padEnd(14)} ${t.status.padEnd(14)} ${t.name}`))) : t === "network" && e.args[1] === "ls" ? e.print("NETWORK ID     NAME      DRIVER    SCOPE\ne12345678901   bridge    bridge    local\nf12345678901   host      host      local") : t === "volume" && e.args[1] === "ls" ? e.print("DRIVER    VOLUME NAME\nlocal     db_data\nlocal     web_static") : t === "logs" ? e.print("[INFO] Starting server...\n[INFO] Listening on port 80\n[DEBUG] Connection from 192.168.1.5") : t === "compose" && e.args[1] === "up" ? e.print("\x1B[1;34m[+] Running 2/2\x1B[0m\n ⠿ Container db      Started\n ⠿ Container web     Started") : t === "swarm" ? e.print("Swarm initialized: current node (manager) is now node-1.") : e.print("Uso: docker [run|ps|exec|stop|logs|network|volume|compose|swarm]");
		}
	},
	{
		name: "singularity",
		...
		execute: async (e) => {
			let t = e.args[0];
			t === "instance" && e.args[1] === "list" ? e.print("INSTANCE NAME    PID      IP              IMAGE\nweb_server       12345    10.0.0.1        nginx.sif") : t === "cache" && e.args[1] === "list" ? e.print("NAME                     DATE        SIZE\nubuntu_latest.sif        2026-04-20  75MB\npython_3.10.sif          2026-04-21  120MB") : t === "pull" ? e.print("INFO:    Pulling from Docker Hub...\n\x1B[1;32mINFO:    Build complete: image.sif\x1B[0m") : e.print("Uso: singularity [pull|exec|shell|instance|cache|inspect]");
		}
	},
	{
		name: "apptainer",
		...
		execute: async (e) => {
			let t = qs.find((e) => e.name === "singularity");
			t && await t.execute(e);
		}
	},
	{
		...
		execute: async (e) => {
			let t = e.args[0];
			t === "init" ? e.print(`\x1b[1;32m✔\x1b[0m Created pixi.toml\n\x1b[1;32m✔\x1b[0m Initialized project in ${e.args[1] || "current directory"}`) : t === "run" ? e.print(`\x1b[1;30m(pixi run: ${e.args[1] || "python"})\x1b[0m\nPython 3.11.0 (main, Apr 23 2026)`) : t === "shell" ? e.print("\x1B[1;34m(pixi-env)\x1B[0m dayhoff@LaBiOmicS:~$ ") : t === "add" ? e.print(`\x1b[1;32m✔\x1b[0m Added ${e.args[1] || "numpy"} to [dependencies]`) : e.print("Usage: pixi [init|add|run|shell|list|remove]");
		}
	},
	{
		name: "deactivate",
		...
		let e = {
			...
			execute: async (e) => {
				...
				this.commands.forEach((e) => {
					t.has(e.name) || t.set(e.name, e);
				});
				let n = Array.from(t.values()).sort((e, t) => e.name.localeCompare(t.name));
				e.print("\x1B[1;32m=== ARAMAS - Ambiente Remoto para o Aprendizado e Manipulação de Arquivos e Sistemas ===\x1B[0m"), e.print("\x1B[1mRecurso Pedagógico para o ensino de Linux e Bioinformática\x1B[0m"), e.print("Coordenado por: \x1B[1;36mProf. Dr. Fabiano B. Menegidio\x1B[0m"), e.print("Desenvolvido por: \x1B[1;36mLaBiOmicS - Laboratório de Bioinformática e Ciências Ômicas\x1B[0m"), e.print("Instituição: \x1B[1;36mUniversidade de Mogi das Cruzes (UMC)\x1B[0m"), e.print("Licença: \x1B[1;33mMIT\x1B[0m"), e.print(`\nTotal de comandos disponíveis: \x1b[1;36m${n.length}\x1b[0m`), e.print("\nDigite \x1B[1;33mcomando --help\x1B[0m para detalhes de uso.\n");
				for (let t of n) {
					let n = t.name.padEnd(15);
					e.print(`  \x1b[1;36m${n}\x1b[0m - ${t.description}`);
				}
				e.print("\n\x1B[1;33mDicas Rápidas:\x1B[0m"), e.print("  \x1B[1;36mmissao\x1B[0m      - Ver o objetivo educacional atual"), e.print("  \x1B[1;36mtema\x1B[0m        - Mudar estilo do terminal"), e.print("  \x1B[1;36mclear\x1B[0m       - Limpar a tela");
			}
		};
		this.commands.set("ajuda", e), this.commands.set("help", e), this.commands.set("tema", {
			name: "tema",
			description: "Muda o estilo visual do terminal",
			execute: async () => {}
		}), this.commands.set("missao", {
			name: "missao",
			description: "Mostra o objetivo atual",
			execute: async () => {}
		}), this.commands.set("quest", {
			name: "missao",
			description: "Mostra o objetivo atual",
			execute: async () => {}
...
], Qs = [
	{
		...
		description: "Usou comandos sudo com sucesso",
		icon: "⚡",
		condition: (e) => e.sudoCount > 0
	},
	{
		id: "pipe_badge",
		name: "Mestre dos Pipes",
		description: "Executou filtros complexos com pipes",
		icon: "🔗",
		condition: (e) => e.pipeCount >= 5
	},
	{
		id: "env_badge",
		name: "Cientista de Ambientes",
		description: "Gerenciou múltiplos ambientes virtuais",
		icon: "🧪",
	...
	loadState() {
		let e = localStorage.getItem("quest_manager_state");
		if (e) {
			let t = JSON.parse(e);
			this.currentQuestIndex = t.index || 0, this.totalXp = t.xp || 0, this.stats = t.stats || this.stats;
		}
		let t = JSON.parse(localStorage.getItem("terminal_envs") || "[\"base\"]");
		this.stats.envCount = t.length;
	}
	saveState() {
		this.isResetting || localStorage.setItem("quest_manager_state", JSON.stringify({
	...
	reset() {
		this.isResetting = !0, this.currentQuestIndex = 0, this.totalXp = 0, this.stats = {
			...
			pipeCount: 0,
			envCount: 1
		}, localStorage.removeItem("quest_manager_state"), localStorage.removeItem("terminal_envs"), localStorage.removeItem("current_env"), localStorage.removeItem("vfs_state");
	}
	checkProgress(e, t, n) {
		let r = this.getCurrentQuest();
		n.startsWith("sudo") && this.stats.sudoCount++, n.includes("|") && this.stats.pipeCount++;
		let i = JSON.parse(localStorage.getItem("terminal_envs") || "[\"base\"]");
		if (this.stats.envCount = i.length, r && r.checkCondition(e, t, n)) {
			let e = this.getRank().name;
	...
	setPromptStyle(e) {
		this.promptStyle = e, this.saveState();
	}
	async triggerCommand(e) {
	...
	printPrompt() {
		...
		switch (this.promptStyle) {
			case "zsh":
				this.terminal.write(`\r\n\x1b[1;36m➜  ${n}\x1b[1;32m${e}\x1b[0m \x1b[1;34mgit:(\x1b[1;31mmain\x1b[1;34m)\x1b[0m `);
				break;
			case "minimal":
				this.terminal.write(`\r\n\x1b[1;32m${n}${e} ${r}\x1b[0m `);
				break;
			default: {
				let i = t === "root" ? "\x1B[1;31m" : "\x1B[1;32m";
				this.terminal.write(`\r\n${n}${i}${t}@LaBiOmics\x1b[0m:\x1b[1;34m${e}\x1b[0m${r} `);
				break;
			}
		}
	...
	saveState() {
		this.isResetting || (localStorage.setItem("vfs_state", JSON.stringify(this.vfs.getState())), localStorage.setItem("prompt_style", this.promptStyle), localStorage.setItem("current_user", this.currentUser), localStorage.setItem("current_env", this.currentEnv), this.onStateChange && this.onStateChange());
	}
	async handleEnter() {
		let e = this.currentLine.trim();
		this.terminal.write("\r\n");
		let t = "";
		e && (this.history.push(e), this.historyIndex = this.history.length, t = e.split(/\s+/)[0], await this.executeCommand(e));
		let n = this.questManager.checkProgress(this.vfs, t, e);
		if (n) {
			let { quest: e, rankUp: t } = n;
			if (this.terminal.write(`\r\n\x1b[1;32m✅ MISSÃO CONCLUÍDA: ${e.title} (+${e.xp} XP)\x1b[0m\r\n`), this.terminal.write(`${e.completionMessage}\r\n`), t) {
				let e = this.questManager.getRank();
				this.terminal.write(`\r\n\x1b[1;33m🎊 PARABÉNS! Você foi promovido(a) a: ${e.name}!\x1b[0m\r\n`);
			}
			let r = this.questManager.getCurrentQuest();
			r ? (this.terminal.write(`\r\n\x1b[1;34m🚀 PRÓXIMA MISSÃO [${r.category}]: ${r.title}\x1b[0m\r\n`), this.terminal.write(`${r.description}\r\n`)) : this.terminal.write("\r\n\x1B[1;35m🏆 PARABÉNS! Você atingiu o ápice da carreira em Bioinformática!\x1B[0m\r\n");
		}
		this.saveState(), this.currentLine = "", this.printPrompt();
	}
	handleBackspace() {
		this.currentLine.length > 0 && (this.currentLine = this.currentLine.slice(0, -1), this.terminal.write("\b \b"));
	}
	handleHistory(e) {
		let t = this.historyIndex + e;
		if (t >= 0 && t < this.history.length) {
			for (let e = 0; e < this.currentLine.length; e++) this.terminal.write("\b \b");
			this.historyIndex = t, this.currentLine = this.history[this.historyIndex], this.terminal.write(this.currentLine);
		}
	}
	async executeCommand(e) {
		let t = this.currentUser, n = e;
		if (e.startsWith("sudo ") && (t = "root", n = e.substring(5), this.terminal.write("[sudo] senha para dayhoff: *******\r\n")), n.includes("|")) {
			let e = n.split("|").map((e) => e.trim()), r = "";
			for (let n = 0; n < e.length; n++) {
				let i = e[n].split(/\s+/), a = i[0], o = [...i.slice(1)];
				r && o.push(r);
				let s = this.registry.getCommand(a);
				if (s) {
					let i = "", a = {
						vfs: this.vfs,
						args: o,
						...
						print: (t) => {
							i += t + "\n", n === e.length - 1 && this.terminal.write(t.replace(/\n/g, "\r\n") + "\r\n");
						},
						printError: (e) => this.terminal.write(`\x1b[31mErro: ${e}\x1b[0m\r\n`),
						clear: () => this.terminal.clear()
					};
					await s.execute(a), r = i.trim();
				} else {
					this.terminal.write(`zsh: comando não encontrado: ${a}\r\n`);
					break;
				}
			}
			return;
		}
		let r = n.split(/\s+/), i = r[0], a = r.slice(1);
		if (i === "missao" || i === "quest") {
			let e = this.questManager.getCurrentQuest(), t = this.questManager.getRank(), n = this.questManager.getXP(), r = this.questManager.getProgressPercentage(), i = "█".repeat(Math.floor(r / 5)) + "░".repeat(20 - Math.floor(r / 5)), a = (e, t = "") => {
				let n = [], r = e;
				for (;;) {
					let e = 0, i = r.length, a = -1;
					for (let t = 0; t < r.length; t++) {
						if (r[t] === "\x1B") {
							let e = r.slice(t).match(/^\x1b\[[0-9;]*m/);
							if (e) {
								t += e[0].length - 1;
								continue;
							}
						}
						if (r[t] === " " && (a = t), e++, /[\uD800-\uDBFF]/.test(r[t]) && t++, e > 65) {
							i = a === -1 ? t : a;
							break;
						}
					}
					let o = r.slice(0, i), s = o.replace(/\x1b\[[0-9;]*m/g, "").replace(/[\uD800-\uDBFF][\uDC00-\uDFFF]/g, " ").length, c = " ".repeat(Math.max(0, 65 - s));
					if (n.push(`║ ${t}${o}\x1b[0m${c} ║\r\n`), r = r.slice(i).trim(), !r) break;
					r = "    " + r;
				}
				return n.join("");
			};
			this.terminal.write(`\r\n\x1b[1;35m╔${"═".repeat(67)}╗\x1b[0m\r\n`), this.terminal.write(a(`\x1b[1mPERFIL:\x1b[0m ${this.currentUser} | \x1b[1mRANK:\x1b[0m ${t.name}`, "\x1B[1m")), this.terminal.write(a(`\x1b[1mPROGRESSO:\x1b[0m [${i}] ${r}% (${n} XP)`)), this.terminal.write(`\x1b[1;35m╟${"─".repeat(67)}╢\x1b[0m\r\n`), e ? (this.terminal.write(a(`🎯 \x1b[1;33mMISSÃO:\x1b[0m ${e.title}`)), this.terminal.write(a(`📂 \x1b[1;34mCATEGORIA:\x1b[0m ${e.category}`)), this.terminal.write(a(`✨ \x1b[1mOBJETIVO:\x1b[0m ${e.description}`)), this.terminal.write(a(`💡 \x1b[1;30mDICA: ${e.hint}`))) : this.terminal.write(a("\x1B[1;32m🏆 JORNADA CONCLUÍDA! VOCÊ É UM MESTRE! \x1B[0m")), this.terminal.write(`\x1b[1;35m╟${"─".repeat(67)}╢\x1b[0m\r\n`), this.terminal.write(a("\x1B[1;30mPara recomeçar sua jornada, digite 'reset'\x1B[0m")), this.terminal.write(`\x1b[1;35m╚${"═".repeat(67)}╝\x1b[0m\r\n`);
			return;
		}
		if (i === "reset") {
		...
		if (i === "tema") {
			...
			!e || ![
				...
				"zsh",
				"minimal"
			].includes(e) ? this.terminal.write("Uso: tema [bash | zsh | minimal]\r\n") : (this.setPromptStyle(e), this.terminal.write(`Estilo alterado para '${e}'.\r\n`));
			return;
		}
		let o = this.registry.getCommand(i);
		if (o) {
			if (a.includes("-h") || a.includes("--help")) {
				this.terminal.write(`\x1b[1;32mAJUDA: ${o.name}\x1b[0m\r\n`), this.terminal.write(`${o.description}\r\n`), o.help ? this.terminal.write(`\r\n\x1b[1;33mUSO:\x1b[0m\r\n${o.help.replace(/\n/g, "\r\n")}\r\n`) : this.terminal.write(`\r\nUso: ${o.name} [argumentos]\r\n`);
				return;
			}
			let e = {
				vfs: this.vfs,
				...
				print: (e) => this.terminal.write(e.replace(/\n/g, "\r\n") + "\r\n"),
				printError: (e) => this.terminal.write(`\x1b[31mErro: ${e}\x1b[0m\r\n`),
				clear: () => this.terminal.clear()
			};
			try {
				...
				this.terminal.write(`\x1b[31mErro ao executar comando: ${e}\x1b[0m\r\n`);
			}
	...
	process.env.NODE_ENV !== "production" && (function() {
		function t(e) {
			...
			if (typeof e == "function") return e.$$typeof === y ? null : e.displayName || e.name || null;
			...
			if (typeof e == "object") switch (typeof e.tag == "number" && console.error("Received an unexpected object in getComponentNameFromType(). This is likely a bug in React. Please file an issue."), e.$$typeof) {
				...
				case se: return n = e.displayName || null, n === null ? t(e.type) || "Memo" : n;
				case ce:
		...
		function l(e, t) {
			function n() {
				x || (x = !0, console.error("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://react.dev/link/special-props)", t));
			}
		...
		function u() {
			var e = t(this.type);
			return S[e] || (S[e] = !0, console.error("Accessing element.ref was removed in React 19. ref is now a regular prop. It will be removed from the JSX Element type in a future release.")), e = this.props.ref, e === void 0 ? null : e;
		}
		...
		function f(e, n, i, a, s, u) {
			...
			if (b.call(n, "key")) {
				...
				a = 0 < m.length ? "{key: someKey, " + m.join(": ..., ") + ": ...}" : "{key: someKey}", me[f + a] || (m = 0 < m.length ? "{" + m.join(": ..., ") + ": ...}" : "{}", console.error("A props object containing a \"key\" prop is being spread into JSX:\n  let props = %s;\n  <%s {...props} />\nReact keys must be passed directly to JSX without using spread:\n  let props = %s;\n  <%s key={someKey} {...props} />", a, f, m, f), me[f + a] = !0);
			}
		...
		function p(e) {
			m(e) ? e._store && (e._store.validated = 1) : typeof e == "object" && e && e.$$typeof === ce && (e._payload.status === "fulfilled" ? m(e._payload.value) && e._payload.value._store && (e._payload.value._store.validated = 1) : e._store && (e._store.validated = 1));
		}
		function m(e) {
			return typeof e == "object" && !!e && e.$$typeof === g;
		}
		var h = i("react"), g = Symbol.for("react.transitional.element"), _ = Symbol.for("react.portal"), v = Symbol.for("react.fragment"), ee = Symbol.for("react.strict_mode"), te = Symbol.for("react.profiler"), ne = Symbol.for("react.consumer"), re = Symbol.for("react.context"), ie = Symbol.for("react.forward_ref"), ae = Symbol.for("react.suspense"), oe = Symbol.for("react.suspense_list"), se = Symbol.for("react.memo"), ce = Symbol.for("react.lazy"), le = Symbol.for("react.activity"), y = Symbol.for("react.client.reference"), ue = h.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, b = Object.prototype.hasOwnProperty, de = Array.isArray, fe = console.createTask ? console.createTask : function() {
			return null;
		};
		h = { react_stack_bottom_frame: function(e) {
			return e();
		} };
		var x, S = {}, C = h.react_stack_bottom_frame.bind(h, s)(), pe = fe(a(s)), me = {};
		e.Fragment = v, e.jsx = function(e, t, n) {
			var r = 1e4 > ue.recentlyCreatedOwnerStacks++;
			return f(e, t, n, !1, r ? Error("react-stack-top-frame") : C, r ? fe(a(e)) : pe);
		}, e.jsxs = function(e, t, n) {
			var r = 1e4 > ue.recentlyCreatedOwnerStacks++;
			return f(e, t, n, !0, r ? Error("react-stack-top-frame") : C, r ? fe(a(e)) : pe);
		};
	})();
})), $ = (/* @__PURE__ */ r(((e, t) => {
	...
	let r = t(null), i = t(null), a = t(null), o = t(null), [s, c] = n(null), [l, u] = n({
		...
		achievements: [],
		percent: 0
	}), [d, f] = n(window.innerWidth > 768), [p, m] = n(window.innerWidth <= 768), [h, g] = n({}), _ = (e) => {
		g((t) => ({
			...t,
			[e]: !t[e]
		}));
	...
	return e(() => {
		let e = () => {
			try {
				a.current && a.current.fit();
			} catch (e) {
				console.warn("Terminal fit failed", e);
			}
		}, t = () => {
			m(window.innerWidth <= 768), requestAnimationFrame(e);
		};
		if (window.addEventListener("resize", t), !r.current) return;
		let n = new Ps({
			cursorBlink: !0,
			scrollback: 1e3,
			theme: {
		...
		let l = () => {
			if (o.current) {
				let e = o.current.getQuestManager(), t = e.getCurrentQuest();
				c(t ? {
					title: t.title,
					...
					percent: e.getProgressPercentage()
				});
			}
		};
		...
		children: [/* @__PURE__ */ (0, $.jsxs)("header", {
			...
			children: [/* @__PURE__ */ (0, $.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, $.jsx)("button", {
					...
					style: {
						fontWeight: 600,
						fontSize: p ? "16px" : "14px",
						letterSpacing: "0.5px"
					},
					children: ["ARAMAS ", /* @__PURE__ */ (0, $.jsx)("span", {
						style: {
							color: "#007acc",
							fontWeight: 400,
							display: p ? "none" : "inline"
						},
						children: "| LABIOMICS"
					})]
				})]
			...
			children: [
				...
				/* @__PURE__ */ (0, $.jsxs)("aside", {
					style: {
						width: p ? "85%" : d ? "300px" : "0px",
						maxWidth: "320px",
						flex: "0 0 auto",
						height: "100%",
						backgroundColor: "#111112",
						borderRight: d || !p ? "1px solid #333" : "none",
						...
						left: 0,
						top: 0,
						transform: p && !d ? "translateX(-100%)" : "translateX(0)",
						boxShadow: p && d ? "10px 0 25px rgba(0,0,0,0.8)" : "none",
						pointerEvents: p && !d ? "none" : "auto"
					},
					children: [
						/* @__PURE__ */ (0, $.jsxs)("div", {
							style: {
							...
							children: [
								...
								/* @__PURE__ */ (0, $.jsxs)("div", { children: [/* @__PURE__ */ (0, $.jsxs)("div", {
									style: {
										display: "flex",
										justifyContent: "space-between",
										fontSize: "11px",
									...
									children: [/* @__PURE__ */ (0, $.jsx)("span", { children: "Progresso Geral" }), /* @__PURE__ */ (0, $.jsxs)("span", {
										style: { color: "#0dbc79" },
										children: [l.percent, "%"]
									})]
								}), /* @__PURE__ */ (0, $.jsx)("div", {
							...
							children: [
								{
									...
									commands: [
										{
											name: "ls",
											desc: "Lista arquivos e diretórios",
											example: "ls -la"
										},
										{
											name: "cd",
										...
										},
										{
											name: "mkdir",
											desc: "Cria uma pasta",
											example: "mkdir analise"
										},
										{
											name: "rm",
											desc: "Remove arquivos/pastas",
											example: "rm -rf tmp/"
										},
										{
											name: "cp/mv",
											desc: "Copia ou move arquivos",
											example: "cp arq.txt backup/"
										},
										{
											name: "touch",
											desc: "Cria arquivo vazio",
											example: "touch nota.txt"
										},
										{
											name: "cat",
											desc: "Mostra conteúdo de arquivo",
											example: "cat seq.fa"
										}
									]
								},
									...
									commands: [
										{
											...
											example: "fastqc reads.fq"
										},
										{
											name: "bwa/bowtie2",
											desc: "Alinhamento de DNA",
											example: "bwa mem ref.fa r1.fq"
										},
										{
											name: "samtools",
											desc: "Manipula arquivos BAM",
											example: "samtools sort aln.bam"
										},
										{
											name: "gatk",
											desc: "Chamada de variantes",
											example: "gatk HaplotypeCaller"
										},
										{
											name: "blastn/p",
											desc: "Busca de similaridade",
											example: "blastn -query q.fa"
										},
										{
											name: "spades",
											desc: "Montagem de genomas",
											example: "spades.py -1 r1.fq"
										},
										{
											name: "kraken2",
											desc: "Taxonomia metagenômica",
											example: "kraken2 --db db r.fq"
										},
										{
											name: "salmon",
											desc: "Expressão gênica RNA-seq",
											example: "salmon quant -i idx"
										},
										{
											name: "bedtools",
											desc: "Aritmética genômica",
								...
								},
								{
									...
									commands: [
										{
											name: "conda/mamba",
											desc: "Cria ambientes e instala pacotes",
											example: "conda create -n bio"
										},
										{
											name: "pip",
											desc: "Pacotes Python",
										...
										{
											name: "pyenv",
											desc: "Versões do Python",
											example: "pyenv global 3.10.4"
										},
										{
											name: "apt",
											desc: "Pacotes do sistema",
											example: "apt install git"
										},
										{
											name: "pixi",
											desc: "Projetos reprodutíveis",
											example: "pixi add numpy"
										}
									]
								},
								{
									...
									commands: [
										...
										{
											name: "singularity",
											desc: "Containers para HPC",
											example: "singularity shell img.sif"
										},
										{
											name: "sbatch/squeue",
											desc: "Slurm Cluster",
										...
										{
											name: "snakemake",
											desc: "Pipelines de bioinfo",
											example: "snakemake -c 4"
										},
										{
											name: "make",
											desc: "Automação de build",
											example: "make all"
										}
									]
								},
								{
									...
									commands: [
										{
											name: "ip addr",
											desc: "Endereços de rede",
											example: "ip a"
										},
										{
											name: "netstat",
											desc: "Portas e conexões",
											example: "netstat -tulpn"
										},
										{
											name: "top/ps",
											desc: "Processos e CPU",
											example: "ps aux"
										},
										{
											name: "free -h",
										...
										{
											name: "df -h",
											desc: "Espaço em disco",
											example: "df -h"
										},
										{
											name: "chmod/chown",
											desc: "Permissões e donos",
									...
									commands: [
										{
											name: "grep",
											desc: "Busca texto",
											example: "grep \"motif\" seq.fa"
										},
										{
											name: "sed/awk",
											desc: "Edição de fluxo/colunas",
											example: "awk \"{print $1}\""
										},
										{
											name: "sort/uniq",
											desc: "Ordenação e contagem",
											example: "sort list.txt | uniq -c"
										},
										{
											name: "head/tail",
											desc: "Início ou fim do arquivo",
											example: "head -n 20 data.txt"
										},
										{
											name: "vim",
											desc: "Editor de texto",
											example: "vim config.yaml"
										}
									]
								}
								...
								children: [/* @__PURE__ */ (0, $.jsxs)("button", {
									...
									style: {
										...
										justifyContent: "space-between",
										alignItems: "center",
										background: h[t] ? "rgba(13, 188, 121, 0.05)" : "none",
										border: "none",
										color: h[t] ? "#0dbc79" : "#ccc",
										fontSize: "13px",
										fontWeight: 600,
										cursor: "pointer",
										textAlign: "left"
									},
									children: [/* @__PURE__ */ (0, $.jsx)("span", { children: e.title }), /* @__PURE__ */ (0, $.jsx)("span", {
										style: {
											fontSize: "10px",
											transform: h[t] ? "rotate(180deg)" : "rotate(0deg)",
											transition: "transform 0.3s"
										},
										children: "▼"
									})]
								}), h[t] && /* @__PURE__ */ (0, $.jsx)("div", {
									style: {
										padding: "12px 15px",
										backgroundColor: "#0f0f10"
									},
									children: e.commands.map((e, t) => /* @__PURE__ */ (0, $.jsxs)("div", {
				...
				/* @__PURE__ */ (0, $.jsxs)("main", {
					...
					children: [/* @__PURE__ */ (0, $.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, $.jsx)("span", {
							...
							children: p ? "dayhoff@ARAMAS" : "ARAMAS — bash — dayhoff@UMC"
						})]
					}), /* @__PURE__ */ (0, $.jsx)("div", {
						ref: r,
						style: {
